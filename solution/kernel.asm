...
8010026b:	5d                   	pop    %ebp
  release(&bcache.lock);
8010026c:	e9 8f 44 00 00       	jmp    80104700 <release>
    panic("brelse");
...
80100551:	e8 6a 43 00 00       	call   801048c0 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100566:	e8 b5 42 00 00       	call   80104820 <memset>
  outb(CRTPORT+1, pos);
...
801005ab:	e8 b0 41 00 00       	call   80104760 <acquire>
  for(i = 0; i < n; i++)
...
801005e4:	e8 17 41 00 00       	call   80104700 <release>
  ilock(ip);
801005e9:	58                   	pop    %eax
...
801007e8:	e8 73 3f 00 00       	call   80104760 <acquire>
...
8010085b:	e8 a0 3e 00 00       	call   80104700 <release>
...
80100893:	e8 c8 3e 00 00       	call   80104760 <acquire>
  while((c = getc()) >= 0){
...
801009d0:	e8 2b 3d 00 00       	call   80104700 <release>
  if(doprocdump) {
...
80100a70:	e8 1b 3b 00 00       	call   80104590 <initlock>
...
80100cd3:	e8 48 3d 00 00       	call   80104a20 <strlen>
...
80100ce4:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100ce7:	e8 34 3d 00 00       	call   80104a20 <strlen>
...
80100da1:	e8 3a 3c 00 00       	call   801049e0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100e20:	e8 6b 37 00 00       	call   80104590 <initlock>
}
...
80100e41:	e8 1a 39 00 00       	call   80104760 <acquire>
...
80100e71:	e8 8a 38 00 00       	call   80104700 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e8a:	e8 71 38 00 00       	call   80104700 <release>
}
...
80100eaf:	e8 ac 38 00 00       	call   80104760 <acquire>
  if(f->ref < 1)
...
80100ecc:	e8 2f 38 00 00       	call   80104700 <release>
  return f;
}
...
80100f01:	e8 5a 38 00 00       	call   80104760 <acquire>
  if(f->ref < 1)
...
80100f39:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f3c:	e8 bf 37 00 00       	call   80104700 <release>
...
80100f6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f6e:	e9 8d 37 00 00       	jmp    80104700 <release>
...
80101325:	e8 f6 34 00 00       	call   80104820 <memset>
  log_write(bp);
...
801013d7:	e8 24 33 00 00       	call   80104700 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 f6 32 00 00       	call   80104700 <release>
      return ip;
...
80101541:	e8 7a 33 00 00       	call   801048c0 <memmove>
  brelse(bp);
...
80101576:	e8 15 30 00 00       	call   80104590 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 cc 2e 00 00       	call   80104460 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 ff 32 00 00       	call   801048c0 <memmove>
  brelse(bp);
...
8010168e:	e8 8d 31 00 00       	call   80104820 <memset>
      dip->type = type;
...
80101731:	e8 8a 31 00 00       	call   801048c0 <memmove>
  log_write(bp);
...
8010175f:	e8 fc 2f 00 00       	call   80104760 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010176f:	e8 8c 2f 00 00       	call   80104700 <release>
}
...
801017a2:	e8 f9 2c 00 00       	call   801044a0 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 a3 30 00 00       	call   801048c0 <memmove>
    brelse(bp);
...
80101873:	e8 c8 2c 00 00       	call   80104540 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 6c 2c 00 00       	jmp    80104500 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 db 2b 00 00       	call   801044a0 <acquiresleep>
...
801018da:	e8 21 2c 00 00       	call   80104500 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801018e6:	e8 75 2e 00 00       	call   80104760 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 fb 2d 00 00       	jmp    80104700 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 f9 10 80       	push   $0x8010f960
80101910:	e8 4b 2e 00 00       	call   80104760 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010191f:	e8 dc 2d 00 00       	call   80104700 <release>
    if(r == 1){
...
80101a23:	e8 18 2b 00 00       	call   80104540 <holdingsleep>
...
80101a3a:	e8 c1 2a 00 00       	call   80104500 <releasesleep>
  iput(ip);
...
80101b37:	e8 84 2d 00 00       	call   801048c0 <memmove>
    brelse(bp);
...
80101c33:	e8 88 2c 00 00       	call   801048c0 <memmove>
    log_write(bp);
...
80101cce:	e8 5d 2c 00 00       	call   80104930 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 fe 2b 00 00       	call   80104930 <strncmp>
      continue;
...
80101dba:	e8 a1 29 00 00       	call   80104760 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101dca:	e8 31 29 00 00       	call   80104700 <release>
...
80101e27:	e8 94 2a 00 00       	call   801048c0 <memmove>
...
80101e8c:	e8 af 26 00 00       	call   80104540 <holdingsleep>
...
80101eae:	e8 4d 26 00 00       	call   80104500 <releasesleep>
  iput(ip);
...
80101edb:	e8 e0 29 00 00       	call   801048c0 <memmove>
    name[len] = 0;
...
80101f2b:	e8 10 26 00 00       	call   80104540 <holdingsleep>
...
80101f4a:	e8 b1 25 00 00       	call   80104500 <releasesleep>
  iput(ip);
...
80101f6d:	e8 ce 25 00 00       	call   80104540 <holdingsleep>
...
80101f90:	e8 ab 25 00 00       	call   80104540 <holdingsleep>
...
80101fa7:	e8 54 25 00 00       	call   80104500 <releasesleep>
}
...
8010203d:	e8 3e 29 00 00       	call   80104980 <strncpy>
...
801021d0:	e8 bb 23 00 00       	call   80104590 <initlock>
...
8010224e:	e8 0d 25 00 00       	call   80104760 <acquire>
...
801022cb:	e8 30 24 00 00       	call   80104700 <release>
...
801022ee:	e8 4d 22 00 00       	call   80104540 <holdingsleep>
...
80102328:	e8 33 24 00 00       	call   80104760 <acquire>
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 75 23 00 00       	jmp    80104700 <release>
...
801024f2:	e8 29 23 00 00       	call   80104820 <memset>
...
80102528:	e8 33 22 00 00       	call   80104760 <acquire>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 b8 21 00 00       	jmp    80104700 <release>
    panic("kfree");
...
80102625:	e8 66 1f 00 00       	call   80104590 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 a8 20 00 00       	call   80104760 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 1a 20 00 00       	call   80104700 <release>
  return (char*)r;
...
80102af7:	e8 74 1d 00 00       	call   80104870 <memcmp>
...
80102c24:	e8 97 1c 00 00       	call   801048c0 <memmove>
...
80102cd4:	e8 b7 18 00 00       	call   80104590 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 f0 19 00 00       	call   80104760 <acquire>
...
80102dbc:	e8 3f 19 00 00       	call   80104700 <release>
      break;
    }
  }
}
...
80102dde:	e8 7d 19 00 00       	call   80104760 <acquire>
  log.outstanding -= 1;
...
80102e1c:	e8 df 18 00 00       	call   80104700 <release>
}
...
80102e36:	e8 25 19 00 00       	call   80104760 <acquire>
    wakeup(&log);
...
80102e58:	e8 a3 18 00 00       	call   80104700 <release>
...
80102eb4:	e8 07 1a 00 00       	call   801048c0 <memmove>
...
80102f14:	e8 e7 17 00 00       	call   80104700 <release>
...
80102f76:	e8 e5 17 00 00       	call   80104760 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 46 17 00 00       	jmp    80104700 <release>
...
801030d4:	e8 e7 17 00 00       	call   801048c0 <memmove>
...
801031c4:	e8 a7 16 00 00       	call   80104870 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 ec 15 00 00       	call   80104870 <memcmp>
...
801033c8:	e8 a3 14 00 00       	call   80104870 <memcmp>
...
801034a9:	e8 e2 10 00 00       	call   80104590 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 1c 12 00 00       	call   80104760 <acquire>
  if(writable){
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 77 11 00 00       	jmp    80104700 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 67 11 00 00       	call   80104700 <release>
    kfree((char*)p);
...
801035dd:	e8 7e 11 00 00       	call   80104760 <acquire>
  for(i = 0; i < n; i++){
...
8010366c:	e8 8f 10 00 00       	call   80104700 <release>
        return -1;
...
801036c2:	e8 39 10 00 00       	call   80104700 <release>
  return n;
...
801036e6:	e8 75 10 00 00       	call   80104760 <acquire>
...
8010377e:	e8 7d 0f 00 00       	call   80104700 <release>
  return i;
...
80103799:	e8 62 0f 00 00       	call   80104700 <release>
      return -1;
...
801037b1:	b9 54 1d 11 80       	mov    $0x80111d54,%ecx
{
...
801037c4:	8b 1d 5c 41 11 80    	mov    0x8011415c,%ebx
      p->pass = global_pass + p->remain;
801037ca:	8b 3d 54 41 11 80    	mov    0x80114154,%edi
      global_stride = STRIDE1 / global_tickets;
801037d0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801037d3:	eb 11                	jmp    801037e6 <wakeup1+0x36>
801037d5:	8d 76 00             	lea    0x0(%esi),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037d8:	81 c1 90 00 00 00    	add    $0x90,%ecx
801037de:	81 f9 54 41 11 80    	cmp    $0x80114154,%ecx
801037e4:	74 3a                	je     80103820 <wakeup1+0x70>
    if(p->state == SLEEPING && p->chan == chan){
801037e6:	83 79 0c 02          	cmpl   $0x2,0xc(%ecx)
801037ea:	75 ec                	jne    801037d8 <wakeup1+0x28>
801037ec:	39 71 20             	cmp    %esi,0x20(%ecx)
801037ef:	75 e7                	jne    801037d8 <wakeup1+0x28>
      global_stride = STRIDE1 / global_tickets;
801037f1:	b8 00 04 00 00       	mov    $0x400,%eax
      global_tickets += p->tickets;
801037f6:	03 59 7c             	add    0x7c(%ecx),%ebx
      p->state = RUNNABLE;
801037f9:	c7 41 0c 03 00 00 00 	movl   $0x3,0xc(%ecx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103800:	81 c1 90 00 00 00    	add    $0x90,%ecx
      global_stride = STRIDE1 / global_tickets;
80103806:	99                   	cltd   
80103807:	f7 fb                	idiv   %ebx
      p->pass = global_pass + p->remain;
80103809:	8b 51 f8             	mov    -0x8(%ecx),%edx
8010380c:	01 fa                	add    %edi,%edx
8010380e:	89 51 f4             	mov    %edx,-0xc(%ecx)
80103811:	ba 01 00 00 00       	mov    $0x1,%edx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103816:	81 f9 54 41 11 80    	cmp    $0x80114154,%ecx
8010381c:	75 c8                	jne    801037e6 <wakeup1+0x36>
8010381e:	66 90                	xchg   %ax,%ax
80103820:	89 c7                	mov    %eax,%edi
80103822:	84 d2                	test   %dl,%dl
80103824:	74 0c                	je     80103832 <wakeup1+0x82>
80103826:	89 3d 58 41 11 80    	mov    %edi,0x80114158
8010382c:	89 1d 5c 41 11 80    	mov    %ebx,0x8011415c
    }  
}
...
80103851:	e8 0a 0f 00 00       	call   80104760 <acquire>
...
80103866:	81 fb 54 41 11 80    	cmp    $0x80114154,%ebx
8010386c:	0f 84 be 00 00 00    	je     80103930 <allocproc+0xf0>
    if(p->state == UNUSED)
80103872:	8b 43 0c             	mov    0xc(%ebx),%eax
80103875:	85 c0                	test   %eax,%eax
80103877:	75 e7                	jne    80103860 <allocproc+0x20>
  global_tickets += p->tickets;
80103879:	a1 5c 41 11 80       	mov    0x8011415c,%eax
  release(&ptable.lock);
8010387e:	83 ec 0c             	sub    $0xc,%esp
  p->tickets = DEFAULT_TICKETS;
80103881:	c7 43 7c 08 00 00 00 	movl   $0x8,0x7c(%ebx)
  p->stride = STRIDE1 / p->tickets;
80103888:	c7 83 80 00 00 00 80 	movl   $0x80,0x80(%ebx)
8010388f:	00 00 00 
  global_tickets += p->tickets;
80103892:	8d 48 08             	lea    0x8(%eax),%ecx
  global_stride = STRIDE1 / global_tickets;
80103895:	b8 00 04 00 00       	mov    $0x400,%eax
  p->pass = 0;
8010389a:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
801038a1:	00 00 00 
  global_stride = STRIDE1 / global_tickets;
801038a4:	99                   	cltd   
  p->state = EMBRYO;
801038a5:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  global_stride = STRIDE1 / global_tickets;
801038ac:	f7 f9                	idiv   %ecx
  global_tickets += p->tickets;
801038ae:	89 0d 5c 41 11 80    	mov    %ecx,0x8011415c
  p->remain = 0;
801038b4:	c7 83 88 00 00 00 00 	movl   $0x0,0x88(%ebx)
801038bb:	00 00 00 
  p->rtime = 0;
801038be:	c7 83 8c 00 00 00 00 	movl   $0x0,0x8c(%ebx)
801038c5:	00 00 00 
  global_stride = STRIDE1 / global_tickets;
801038c8:	a3 58 41 11 80       	mov    %eax,0x80114158
  p->pid = nextpid++;
801038cd:	a1 04 a0 10 80       	mov    0x8010a004,%eax
801038d2:	89 43 10             	mov    %eax,0x10(%ebx)
801038d5:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801038d8:	68 20 1d 11 80       	push   $0x80111d20
  p->pid = nextpid++;
801038dd:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801038e3:	e8 18 0e 00 00       	call   80104700 <release>
  if((p->kstack = kalloc()) == 0){
801038e8:	e8 93 ed ff ff       	call   80102680 <kalloc>
801038ed:	83 c4 10             	add    $0x10,%esp
801038f0:	89 43 08             	mov    %eax,0x8(%ebx)
801038f3:	85 c0                	test   %eax,%eax
801038f5:	74 52                	je     80103949 <allocproc+0x109>
  sp -= sizeof *p->tf;
801038f7:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  memset(p->context, 0, sizeof *p->context);
801038fd:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->context;
80103900:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103905:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103908:	c7 40 14 80 5b 10 80 	movl   $0x80105b80,0x14(%eax)
  p->context = (struct context*)sp;
8010390f:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103912:	6a 14                	push   $0x14
80103914:	6a 00                	push   $0x0
80103916:	50                   	push   %eax
80103917:	e8 04 0f 00 00       	call   80104820 <memset>
  p->context->eip = (uint)forkret;
8010391c:	8b 43 1c             	mov    0x1c(%ebx),%eax
  return p;
8010391f:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
80103922:	c7 40 10 60 39 10 80 	movl   $0x80103960,0x10(%eax)
}
...
8010393a:	e8 c1 0d 00 00       	call   80104700 <release>
}
...
8010396b:	e8 90 0d 00 00       	call   80104700 <release>
  if (first) {
...
8010398f:	e8 cc db ff ff       	call   80101560 <iinit>
    initlog(ROOTDEV);
80103994:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010399b:	e8 20 f3 ff ff       	call   80102cc0 <initlog>
}
...
801039b6:	68 40 7a 10 80       	push   $0x80107a40
801039bb:	68 20 1d 11 80       	push   $0x80111d20
801039c0:	e8 cb 0b 00 00       	call   80104590 <initlock>
}
...
80103a54:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103a57:	e8 b4 0b 00 00       	call   80104610 <pushcli>
  c = mycpu();
80103a5c:	e8 6f ff ff ff       	call   801039d0 <mycpu>
  p = c->proc;
80103a61:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a67:	e8 f4 0b 00 00       	call   80104660 <popcli>
}
...
80103a84:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
80103a87:	e8 b4 fd ff ff       	call   80103840 <allocproc>
80103a8c:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103a8e:	a3 60 41 11 80       	mov    %eax,0x80114160
  if((p->pgdir = setupkvm()) == 0)
80103a93:	e8 08 37 00 00       	call   801071a0 <setupkvm>
...
80103ab1:	e8 9a 33 00 00       	call   80106e50 <inituvm>
...
80103ac6:	e8 55 0d 00 00       	call   80104820 <memset>
...
80103b1f:	68 70 7a 10 80       	push   $0x80107a70
80103b24:	50                   	push   %eax
80103b25:	e8 b6 0e 00 00       	call   801049e0 <safestrcpy>
  p->cwd = namei("/");
80103b2a:	c7 04 24 79 7a 10 80 	movl   $0x80107a79,(%esp)
...
80103b63:	68 57 7a 10 80       	push   $0x80107a57
...
80103b75:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103b78:	e8 93 0a 00 00       	call   80104610 <pushcli>
  c = mycpu();
80103b7d:	e8 4e fe ff ff       	call   801039d0 <mycpu>
  p = c->proc;
80103b82:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b88:	e8 d3 0a 00 00       	call   80104660 <popcli>
  sz = curproc->sz;
...
80103b9b:	e8 a0 31 00 00       	call   80106d40 <switchuvm>
  return 0;
...
80103bba:	e8 01 34 00 00       	call   80106fc0 <allocuvm>
...
80103bda:	e8 11 35 00 00       	call   801070f0 <deallocuvm>
...
80103bf6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103bf9:	e8 12 0a 00 00       	call   80104610 <pushcli>
  c = mycpu();
80103bfe:	e8 cd fd ff ff       	call   801039d0 <mycpu>
  p = c->proc;
80103c03:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c09:	e8 52 0a 00 00       	call   80104660 <popcli>
  if((np = allocproc()) == 0){
80103c0e:	e8 2d fc ff ff       	call   80103840 <allocproc>
...
80103c28:	e8 63 36 00 00       	call   80107290 <copyuvm>
...
80103d3b:	e8 20 0a 00 00       	call   80104760 <acquire>
80103d40:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d43:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80103d48:	eb 22                	jmp    80103d6c <scheduler+0x5c>
80103d4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        } else if(p->pass == min_pass_proc->pass){
80103d50:	0f 84 a2 00 00 00    	je     80103df8 <scheduler+0xe8>
80103d56:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103d5d:	8d 76 00             	lea    0x0(%esi),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d60:	05 90 00 00 00       	add    $0x90,%eax
80103d65:	3d 54 41 11 80       	cmp    $0x80114154,%eax
80103d6a:	74 26                	je     80103d92 <scheduler+0x82>
      if(p->state != RUNNABLE)
80103d6c:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103d70:	75 ee                	jne    80103d60 <scheduler+0x50>
      if(min_pass_proc == 0){
80103d72:	85 ff                	test   %edi,%edi
80103d74:	74 0e                	je     80103d84 <scheduler+0x74>
        if(p->pass < min_pass_proc->pass){
80103d76:	8b 97 84 00 00 00    	mov    0x84(%edi),%edx
80103d7c:	39 90 84 00 00 00    	cmp    %edx,0x84(%eax)
80103d82:	7d cc                	jge    80103d50 <scheduler+0x40>
80103d84:	89 c7                	mov    %eax,%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d86:	05 90 00 00 00       	add    $0x90,%eax
80103d8b:	3d 54 41 11 80       	cmp    $0x80114154,%eax
80103d90:	75 da                	jne    80103d6c <scheduler+0x5c>
    if(min_pass_proc != 0){
80103d92:	85 ff                	test   %edi,%edi
80103d94:	0f 84 84 00 00 00    	je     80103e1e <scheduler+0x10e>
      switchuvm(p);
80103d9a:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103d9d:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(p);
80103da3:	57                   	push   %edi
80103da4:	e8 97 2f 00 00       	call   80106d40 <switchuvm>
      p->state = RUNNING;
80103da9:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), p->context);
80103db0:	58                   	pop    %eax
80103db1:	5a                   	pop    %edx
80103db2:	ff 77 1c             	push   0x1c(%edi)
80103db5:	56                   	push   %esi
80103db6:	e8 80 0c 00 00       	call   80104a3b <swtch>
      switchkvm();
80103dbb:	e8 70 2f 00 00       	call   80106d30 <switchkvm>
      p->pass += p->stride;
80103dc0:	8b 87 80 00 00 00    	mov    0x80(%edi),%eax
80103dc6:	01 87 84 00 00 00    	add    %eax,0x84(%edi)
      c->proc = 0;
80103dcc:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103dd3:	00 00 00 
      global_pass += global_stride;
80103dd6:	a1 58 41 11 80       	mov    0x80114158,%eax
      release(&ptable.lock);
80103ddb:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
      global_pass += global_stride;
80103de2:	01 05 54 41 11 80    	add    %eax,0x80114154
      release(&ptable.lock);
80103de8:	e8 13 09 00 00       	call   80104700 <release>
80103ded:	83 c4 10             	add    $0x10,%esp
80103df0:	e9 3b ff ff ff       	jmp    80103d30 <scheduler+0x20>
80103df5:	8d 76 00             	lea    0x0(%esi),%esi
          if(p->rtime < min_pass_proc->rtime){
80103df8:	8b 8f 8c 00 00 00    	mov    0x8c(%edi),%ecx
80103dfe:	39 88 8c 00 00 00    	cmp    %ecx,0x8c(%eax)
80103e04:	0f 8c 7a ff ff ff    	jl     80103d84 <scheduler+0x74>
          } else if(p->rtime == min_pass_proc->rtime){
80103e0a:	0f 85 50 ff ff ff    	jne    80103d60 <scheduler+0x50>
            if(p->pid < min_pass_proc->pid){
80103e10:	8b 4f 10             	mov    0x10(%edi),%ecx
80103e13:	39 48 10             	cmp    %ecx,0x10(%eax)
80103e16:	0f 4c f8             	cmovl  %eax,%edi
80103e19:	e9 42 ff ff ff       	jmp    80103d60 <scheduler+0x50>
      release(&ptable.lock);
80103e1e:	83 ec 0c             	sub    $0xc,%esp
80103e21:	68 20 1d 11 80       	push   $0x80111d20
80103e26:	e8 d5 08 00 00       	call   80104700 <release>
80103e2b:	83 c4 10             	add    $0x10,%esp
80103e2e:	e9 fd fe ff ff       	jmp    80103d30 <scheduler+0x20>
...
80103e44:	53                   	push   %ebx
  pushcli();
80103e45:	e8 c6 07 00 00       	call   80104610 <pushcli>
  c = mycpu();
80103e4a:	e8 81 fb ff ff       	call   801039d0 <mycpu>
  p = c->proc;
80103e4f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e55:	e8 06 08 00 00       	call   80104660 <popcli>
  if(!holding(&ptable.lock))
80103e5a:	83 ec 0c             	sub    $0xc,%esp
80103e5d:	68 20 1d 11 80       	push   $0x80111d20
80103e62:	e8 59 08 00 00       	call   801046c0 <holding>
80103e67:	83 c4 10             	add    $0x10,%esp
80103e6a:	85 c0                	test   %eax,%eax
80103e6c:	74 4f                	je     80103ebd <sched+0x7d>
  if(mycpu()->ncli != 1)
80103e6e:	e8 5d fb ff ff       	call   801039d0 <mycpu>
...
80103e87:	75 41                	jne    80103eca <sched+0x8a>
  intena = mycpu()->intena;
80103e89:	e8 42 fb ff ff       	call   801039d0 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103e8e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103e91:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103e97:	e8 34 fb ff ff       	call   801039d0 <mycpu>
80103e9c:	83 ec 08             	sub    $0x8,%esp
80103e9f:	ff 70 04             	push   0x4(%eax)
80103ea2:	53                   	push   %ebx
80103ea3:	e8 93 0b 00 00       	call   80104a3b <swtch>
  mycpu()->intena = intena;
80103ea8:	e8 23 fb ff ff       	call   801039d0 <mycpu>
}
...
80103f06:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103f09:	e8 42 fb ff ff       	call   80103a50 <myproc>
  if(curproc == initproc)
80103f0e:	39 05 60 41 11 80    	cmp    %eax,0x80114160
80103f14:	0f 84 df 00 00 00    	je     80103ff9 <exit+0xf9>
...
80103f6a:	e8 f1 07 00 00       	call   80104760 <acquire>
  global_tickets -= curproc->tickets;
80103f6f:	8b 0d 5c 41 11 80    	mov    0x8011415c,%ecx
80103f75:	2b 4e 7c             	sub    0x7c(%esi),%ecx
  if(global_tickets > 0)
80103f78:	83 c4 10             	add    $0x10,%esp
  global_tickets -= curproc->tickets;
80103f7b:	89 0d 5c 41 11 80    	mov    %ecx,0x8011415c
    global_stride = 0;  // 防止除以零
80103f81:	31 c0                	xor    %eax,%eax
  if(global_tickets > 0)
80103f83:	85 c9                	test   %ecx,%ecx
80103f85:	7e 08                	jle    80103f8f <exit+0x8f>
    global_stride = STRIDE1 / global_tickets;
80103f87:	b8 00 04 00 00       	mov    $0x400,%eax
80103f8c:	99                   	cltd   
80103f8d:	f7 f9                	idiv   %ecx
80103f8f:	a3 58 41 11 80       	mov    %eax,0x80114158
  wakeup1(curproc->parent);
80103f94:	8b 46 14             	mov    0x14(%esi),%eax
80103f97:	e8 14 f8 ff ff       	call   801037b0 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f9c:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
80103fa1:	eb 13                	jmp    80103fb6 <exit+0xb6>
80103fa3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103fa7:	90                   	nop
80103fa8:	81 c3 90 00 00 00    	add    $0x90,%ebx
80103fae:	81 fb 54 41 11 80    	cmp    $0x80114154,%ebx
80103fb4:	74 2a                	je     80103fe0 <exit+0xe0>
    if(p->parent == curproc){
80103fb6:	39 73 14             	cmp    %esi,0x14(%ebx)
80103fb9:	75 ed                	jne    80103fa8 <exit+0xa8>
      p->parent = initproc;
80103fbb:	a1 60 41 11 80       	mov    0x80114160,%eax
      if(p->state == ZOMBIE)
80103fc0:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
      p->parent = initproc;
80103fc4:	89 43 14             	mov    %eax,0x14(%ebx)
      if(p->state == ZOMBIE)
80103fc7:	75 df                	jne    80103fa8 <exit+0xa8>
        wakeup1(initproc);
80103fc9:	e8 e2 f7 ff ff       	call   801037b0 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fce:	81 c3 90 00 00 00    	add    $0x90,%ebx
80103fd4:	81 fb 54 41 11 80    	cmp    $0x80114154,%ebx
80103fda:	75 da                	jne    80103fb6 <exit+0xb6>
80103fdc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  curproc->state = ZOMBIE;
80103fe0:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
80103fe7:	e8 54 fe ff ff       	call   80103e40 <sched>
  panic("zombie exit");
80103fec:	83 ec 0c             	sub    $0xc,%esp
80103fef:	68 c8 7a 10 80       	push   $0x80107ac8
80103ff4:	e8 87 c3 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ff9:	83 ec 0c             	sub    $0xc,%esp
80103ffc:	68 bb 7a 10 80       	push   $0x80107abb
...
8010401c:	e8 3f 07 00 00       	call   80104760 <acquire>
  pushcli();
80104021:	e8 ea 05 00 00       	call   80104610 <pushcli>
  c = mycpu();
80104026:	e8 a5 f9 ff ff       	call   801039d0 <mycpu>
  p = c->proc;
...
80104036:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
8010403d:	e8 fe fd ff ff       	call   80103e40 <sched>
  release(&ptable.lock);
80104042:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80104049:	e8 b2 06 00 00       	call   80104700 <release>
}
...
8010406c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010406f:	e8 9c 05 00 00       	call   80104610 <pushcli>
  c = mycpu();
80104074:	e8 57 f9 ff ff       	call   801039d0 <mycpu>
  p = c->proc;
...
80104086:	0f 84 49 01 00 00    	je     801041d5 <sleep+0x175>
  if(lk == 0)
8010408c:	85 f6                	test   %esi,%esi
8010408e:	0f 84 34 01 00 00    	je     801041c8 <sleep+0x168>
  if(lk != &ptable.lock){  //DOC: sleeplock0
80104094:	81 fe 20 1d 11 80    	cmp    $0x80111d20,%esi
8010409a:	0f 84 a8 00 00 00    	je     80104148 <sleep+0xe8>
    acquire(&ptable.lock);  //DOC: sleeplock1
801040a0:	83 ec 0c             	sub    $0xc,%esp
801040a3:	68 20 1d 11 80       	push   $0x80111d20
801040a8:	e8 b3 06 00 00       	call   80104760 <acquire>
    release(lk);
801040ad:	89 34 24             	mov    %esi,(%esp)
801040b0:	e8 4b 06 00 00       	call   80104700 <release>
  global_tickets -= p->tickets;
801040b5:	8b 0d 5c 41 11 80    	mov    0x8011415c,%ecx
801040bb:	2b 4b 7c             	sub    0x7c(%ebx),%ecx
  if(global_tickets > 0)
801040be:	83 c4 10             	add    $0x10,%esp
  p->remain = p->pass - global_pass;
801040c1:	8b 83 84 00 00 00    	mov    0x84(%ebx),%eax
801040c7:	2b 05 54 41 11 80    	sub    0x80114154,%eax
  global_tickets -= p->tickets;
801040cd:	89 0d 5c 41 11 80    	mov    %ecx,0x8011415c
  p->remain = p->pass - global_pass;
801040d3:	89 83 88 00 00 00    	mov    %eax,0x88(%ebx)
  if(global_tickets > 0)
801040d9:	85 c9                	test   %ecx,%ecx
801040db:	7e 43                	jle    80104120 <sleep+0xc0>
    global_stride = STRIDE1 / global_tickets;
801040dd:	b8 00 04 00 00       	mov    $0x400,%eax
  p->chan = chan;
801040e2:	89 7b 20             	mov    %edi,0x20(%ebx)
    global_stride = STRIDE1 / global_tickets;
801040e5:	99                   	cltd   
  p->state = SLEEPING;
801040e6:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
    global_stride = STRIDE1 / global_tickets;
801040ed:	f7 f9                	idiv   %ecx
801040ef:	a3 58 41 11 80       	mov    %eax,0x80114158
  sched();
801040f4:	e8 47 fd ff ff       	call   80103e40 <sched>
  p->chan = 0;
801040f9:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80104100:	83 ec 0c             	sub    $0xc,%esp
80104103:	68 20 1d 11 80       	push   $0x80111d20
80104108:	e8 f3 05 00 00       	call   80104700 <release>
    acquire(lk);
8010410d:	89 75 08             	mov    %esi,0x8(%ebp)
...
80104119:	5d                   	pop    %ebp
    acquire(lk);
8010411a:	e9 41 06 00 00       	jmp    80104760 <acquire>
8010411f:	90                   	nop
  p->chan = chan;
80104120:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
80104123:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
8010412a:	c7 05 58 41 11 80 00 	movl   $0x0,0x80114158
80104131:	00 00 00 
  sched();
80104134:	e8 07 fd ff ff       	call   80103e40 <sched>
  p->chan = 0;
80104139:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104140:	eb be                	jmp    80104100 <sleep+0xa0>
80104142:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  global_tickets -= p->tickets;
80104148:	8b 0d 5c 41 11 80    	mov    0x8011415c,%ecx
  p->remain = p->pass - global_pass;
8010414e:	8b 83 84 00 00 00    	mov    0x84(%ebx),%eax
  global_tickets -= p->tickets;
80104154:	2b 4b 7c             	sub    0x7c(%ebx),%ecx
  p->remain = p->pass - global_pass;
80104157:	2b 05 54 41 11 80    	sub    0x80114154,%eax
8010415d:	89 83 88 00 00 00    	mov    %eax,0x88(%ebx)
  global_tickets -= p->tickets;
80104163:	89 0d 5c 41 11 80    	mov    %ecx,0x8011415c
  if(global_tickets > 0)
80104169:	85 c9                	test   %ecx,%ecx
8010416b:	7e 33                	jle    801041a0 <sleep+0x140>
    global_stride = STRIDE1 / global_tickets;
8010416d:	b8 00 04 00 00       	mov    $0x400,%eax
  p->chan = chan;
80104172:	89 7b 20             	mov    %edi,0x20(%ebx)
    global_stride = STRIDE1 / global_tickets;
80104175:	99                   	cltd   
  p->state = SLEEPING;
80104176:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
    global_stride = STRIDE1 / global_tickets;
8010417d:	f7 f9                	idiv   %ecx
8010417f:	a3 58 41 11 80       	mov    %eax,0x80114158
  sched();
80104184:	e8 b7 fc ff ff       	call   80103e40 <sched>
  p->chan = 0;
80104189:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
...
8010419f:	90                   	nop
  p->chan = chan;
801041a0:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
801041a3:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
801041aa:	c7 05 58 41 11 80 00 	movl   $0x0,0x80114158
801041b1:	00 00 00 
  sched();
801041b4:	e8 87 fc ff ff       	call   80103e40 <sched>
  p->chan = 0;
801041b9:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
...
801041cb:	68 da 7a 10 80       	push   $0x80107ada
801041d0:	e8 ab c1 ff ff       	call   80100380 <panic>
    panic("sleep");
801041d5:	83 ec 0c             	sub    $0xc,%esp
801041d8:	68 d4 7a 10 80       	push   $0x80107ad4
801041dd:	e8 9e c1 ff ff       	call   80100380 <panic>
...
801041f4:	53                   	push   %ebx
  pushcli();
801041f5:	e8 16 04 00 00       	call   80104610 <pushcli>
  c = mycpu();
801041fa:	e8 d1 f7 ff ff       	call   801039d0 <mycpu>
  p = c->proc;
801041ff:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104205:	e8 56 04 00 00       	call   80104660 <popcli>
  acquire(&ptable.lock);
8010420a:	83 ec 0c             	sub    $0xc,%esp
8010420d:	68 20 1d 11 80       	push   $0x80111d20
80104212:	e8 49 05 00 00       	call   80104760 <acquire>
80104217:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010421a:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010421c:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
80104221:	eb 13                	jmp    80104236 <wait+0x46>
80104223:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104227:	90                   	nop
80104228:	81 c3 90 00 00 00    	add    $0x90,%ebx
8010422e:	81 fb 54 41 11 80    	cmp    $0x80114154,%ebx
...
8010423f:	74 37                	je     80104278 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104241:	81 c3 90 00 00 00    	add    $0x90,%ebx
      havekids = 1;
80104247:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010424c:	81 fb 54 41 11 80    	cmp    $0x80114154,%ebx
80104252:	75 e2                	jne    80104236 <wait+0x46>
    if(!havekids || curproc->killed){
80104254:	85 c0                	test   %eax,%eax
80104256:	74 76                	je     801042ce <wait+0xde>
80104258:	8b 46 24             	mov    0x24(%esi),%eax
8010425b:	85 c0                	test   %eax,%eax
8010425d:	75 6f                	jne    801042ce <wait+0xde>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
8010425f:	83 ec 08             	sub    $0x8,%esp
80104262:	68 20 1d 11 80       	push   $0x80111d20
80104267:	56                   	push   %esi
80104268:	e8 f3 fd ff ff       	call   80104060 <sleep>
    havekids = 0;
8010426d:	83 c4 10             	add    $0x10,%esp
80104270:	eb a8                	jmp    8010421a <wait+0x2a>
80104272:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        kfree(p->kstack);
80104278:	83 ec 0c             	sub    $0xc,%esp
8010427b:	ff 73 08             	push   0x8(%ebx)
        pid = p->pid;
8010427e:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104281:	e8 3a e2 ff ff       	call   801024c0 <kfree>
        freevm(p->pgdir);
80104286:	5a                   	pop    %edx
...
8010428a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104291:	e8 8a 2e 00 00       	call   80107120 <freevm>
        release(&ptable.lock);
80104296:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
        p->pid = 0;
8010429d:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
801042a4:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
801042ab:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
801042af:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
801042b6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801042bd:	e8 3e 04 00 00       	call   80104700 <release>
        return pid;
801042c2:	83 c4 10             	add    $0x10,%esp
}
801042c5:	8d 65 f8             	lea    -0x8(%ebp),%esp
801042c8:	89 f0                	mov    %esi,%eax
801042ca:	5b                   	pop    %ebx
801042cb:	5e                   	pop    %esi
801042cc:	5d                   	pop    %ebp
801042cd:	c3                   	ret    
...
801042ce:	83 ec 0c             	sub    $0xc,%esp
      return -1;
801042d1:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801042d6:	68 20 1d 11 80       	push   $0x80111d20
801042db:	e8 20 04 00 00       	call   80104700 <release>
      return -1;
801042e0:	83 c4 10             	add    $0x10,%esp
801042e3:	eb e0                	jmp    801042c5 <wait+0xd5>
...
801042ff:	e8 5c 04 00 00       	call   80104760 <acquire>
  wakeup1(chan);
80104304:	89 d8                	mov    %ebx,%eax
80104306:	e8 a5 f4 ff ff       	call   801037b0 <wakeup1>
  release(&ptable.lock);
8010430b:	c7 45 08 20 1d 11 80 	movl   $0x80111d20,0x8(%ebp)
}
...
80104318:	c9                   	leave  
  release(&ptable.lock);
80104319:	e9 e2 03 00 00       	jmp    80104700 <release>
...
8010432f:	e8 2c 04 00 00       	call   80104760 <acquire>
...
80104345:	3d 54 41 11 80       	cmp    $0x80114154,%eax
...
80104368:	68 20 1d 11 80       	push   $0x80111d20
8010436d:	e8 8e 03 00 00       	call   80104700 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104388:	e8 73 03 00 00       	call   80104700 <release>
}
...
801043df:	74 e7                	je     801043c8 <procdump+0x28>
      state = "???";
801043e1:	ba eb 7a 10 80       	mov    $0x80107aeb,%edx
...
801043eb:	8b 14 85 4c 7b 10 80 	mov    -0x7fef84b4(,%eax,4),%edx
      state = "???";
801043f2:	b8 eb 7a 10 80       	mov    $0x80107aeb,%eax
...
80104401:	68 ef 7a 10 80       	push   $0x80107aef
...
8010443d:	68 41 75 10 80       	push   $0x80107541
...
8010446a:	68 64 7b 10 80       	push   $0x80107b64
...
801044af:	e8 ac 02 00 00       	call   80104760 <acquire>
  while (lk->locked) {
...
801044c5:	e8 96 fb ff ff       	call   80104060 <sleep>
  while (lk->locked) {
...
801044d3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801044d9:	e8 72 f5 ff ff       	call   80103a50 <myproc>
...
801044ec:	5d                   	pop    %ebp
  release(&lk->lk);
801044ed:	e9 0e 02 00 00       	jmp    80104700 <release>
...
8010450f:	e8 4c 02 00 00       	call   80104760 <acquire>
  lk->locked = 0;
...
80104524:	e8 c7 fd ff ff       	call   801042f0 <wakeup>
  release(&lk->lk);
...
80104534:	5d                   	pop    %ebp
  release(&lk->lk);
80104535:	e9 c6 01 00 00       	jmp    80104700 <release>
...
80104552:	e8 09 02 00 00       	call   80104760 <acquire>
...
80104564:	e8 97 01 00 00       	call   80104700 <release>
  return r;
}
...
8010457b:	e8 d0 f4 ff ff       	call   80103a50 <myproc>
...
8010463a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80104640:	e8 8b f3 ff ff       	call   801039d0 <mycpu>
...
8010468c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104690:	e8 3b f3 ff ff       	call   801039d0 <mycpu>
...
801046a5:	68 6f 7b 10 80       	push   $0x80107b6f
801046aa:	e8 d1 bc ff ff       	call   80100380 <panic>
    panic("popcli");
801046af:	83 ec 0c             	sub    $0xc,%esp
801046b2:	68 86 7b 10 80       	push   $0x80107b86
...
801046e3:	e8 e8 f2 ff ff       	call   801039d0 <mycpu>
...
80104778:	75 7e                	jne    801047f8 <acquire+0x98>
  popcli();
8010477a:	e8 e1 fe ff ff       	call   80104660 <popcli>
  asm volatile("lock; xchgl %0, %1" :
8010477f:	b9 01 00 00 00       	mov    $0x1,%ecx
80104784:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  while(xchg(&lk->locked, 1) != 0)
80104788:	8b 55 08             	mov    0x8(%ebp),%edx
8010478b:	89 c8                	mov    %ecx,%eax
8010478d:	f0 87 02             	lock xchg %eax,(%edx)
80104790:	85 c0                	test   %eax,%eax
80104792:	75 f4                	jne    80104788 <acquire+0x28>
  __sync_synchronize();
80104794:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80104799:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010479c:	e8 2f f2 ff ff       	call   801039d0 <mycpu>
  getcallerpcs(&lk, lk->pcs);
801047a1:	8b 4d 08             	mov    0x8(%ebp),%ecx
  ebp = (uint*)v - 2;
801047a4:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
801047a6:	89 43 08             	mov    %eax,0x8(%ebx)
  for(i = 0; i < 10; i++){
801047a9:	31 c0                	xor    %eax,%eax
801047ab:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801047af:	90                   	nop
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801047b0:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
801047b6:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
801047bc:	77 1a                	ja     801047d8 <acquire+0x78>
    pcs[i] = ebp[1];     // saved %eip
801047be:	8b 5a 04             	mov    0x4(%edx),%ebx
801047c1:	89 5c 81 0c          	mov    %ebx,0xc(%ecx,%eax,4)
  for(i = 0; i < 10; i++){
...
801047d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
801047d8:	8d 44 81 0c          	lea    0xc(%ecx,%eax,4),%eax
801047dc:	8d 51 34             	lea    0x34(%ecx),%edx
801047df:	90                   	nop
    pcs[i] = 0;
...
801047f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
801047f8:	8b 5b 08             	mov    0x8(%ebx),%ebx
801047fb:	e8 d0 f1 ff ff       	call   801039d0 <mycpu>
80104800:	39 c3                	cmp    %eax,%ebx
80104802:	0f 85 72 ff ff ff    	jne    8010477a <acquire+0x1a>
  popcli();
80104808:	e8 53 fe ff ff       	call   80104660 <popcli>
    panic("acquire");
8010480d:	83 ec 0c             	sub    $0xc,%esp
80104810:	68 95 7b 10 80       	push   $0x80107b95
...
80104830:	09 cf                	or     %ecx,%edi
80104832:	83 e7 03             	and    $0x3,%edi
80104835:	75 29                	jne    80104860 <memset+0x40>
    c &= 0xFF;
80104837:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010483a:	c1 e0 18             	shl    $0x18,%eax
8010483d:	89 fb                	mov    %edi,%ebx
8010483f:	c1 e9 02             	shr    $0x2,%ecx
80104842:	c1 e3 10             	shl    $0x10,%ebx
80104845:	09 d8                	or     %ebx,%eax
80104847:	09 f8                	or     %edi,%eax
80104849:	c1 e7 08             	shl    $0x8,%edi
8010484c:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
8010484e:	89 d7                	mov    %edx,%edi
80104850:	fc                   	cld    
80104851:	f3 ab                	rep stos %eax,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
80104853:	5b                   	pop    %ebx
80104854:	89 d0                	mov    %edx,%eax
80104856:	5f                   	pop    %edi
80104857:	5d                   	pop    %ebp
80104858:	c3                   	ret    
...
80104880:	74 2e                	je     801048b0 <memcmp+0x40>
80104882:	01 c6                	add    %eax,%esi
80104884:	eb 14                	jmp    8010489a <memcmp+0x2a>
...
801048cb:	8b 75 0c             	mov    0xc(%ebp),%esi
  ...
  d = dst;
  if(s < d && s + n > d){
801048ce:	39 d6                	cmp    %edx,%esi
801048d0:	73 26                	jae    801048f8 <memmove+0x38>
801048d2:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
801048d5:	39 fa                	cmp    %edi,%edx
801048d7:	73 1f                	jae    801048f8 <memmove+0x38>
801048d9:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
801048dc:	85 c9                	test   %ecx,%ecx
801048de:	74 0c                	je     801048ec <memmove+0x2c>
      *--d = *--s;
801048e0:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
801048e4:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
801048e7:	83 e8 01             	sub    $0x1,%eax
801048ea:	73 f4                	jae    801048e0 <memmove+0x20>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
801048ec:	5e                   	pop    %esi
801048ed:	89 d0                	mov    %edx,%eax
801048ef:	5f                   	pop    %edi
801048f0:	5d                   	pop    %ebp
801048f1:	c3                   	ret    
801048f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(n-- > 0)
801048f8:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
801048fb:	89 d7                	mov    %edx,%edi
801048fd:	85 c9                	test   %ecx,%ecx
801048ff:	74 eb                	je     801048ec <memmove+0x2c>
80104901:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
80104908:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
80104909:	39 c6                	cmp    %eax,%esi
8010490b:	75 fb                	jne    80104908 <memmove+0x48>
}
8010490d:	5e                   	pop    %esi
...
80104920:	eb 9e                	jmp    801048c0 <memmove>
...
80104937:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010493a:	53                   	push   %ebx
8010493b:	8b 55 0c             	mov    0xc(%ebp),%edx
  while(n > 0 && *p && *p == *q)
8010493e:	85 f6                	test   %esi,%esi
80104940:	74 2e                	je     80104970 <strncmp+0x40>
80104942:	01 d6                	add    %edx,%esi
80104944:	eb 18                	jmp    8010495e <strncmp+0x2e>
80104946:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010494d:	8d 76 00             	lea    0x0(%esi),%esi
80104950:	38 d8                	cmp    %bl,%al
80104952:	75 14                	jne    80104968 <strncmp+0x38>
    n--, p++, q++;
80104954:	83 c2 01             	add    $0x1,%edx
80104957:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
8010495a:	39 f2                	cmp    %esi,%edx
8010495c:	74 12                	je     80104970 <strncmp+0x40>
8010495e:	0f b6 01             	movzbl (%ecx),%eax
80104961:	0f b6 1a             	movzbl (%edx),%ebx
80104964:	84 c0                	test   %al,%al
80104966:	75 e8                	jne    80104950 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104968:	29 d8                	sub    %ebx,%eax
}
8010496a:	5b                   	pop    %ebx
8010496b:	5e                   	pop    %esi
8010496c:	5d                   	pop    %ebp
...
80104989:	8b 4d 10             	mov    0x10(%ebp),%ecx
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
8010498c:	89 f0                	mov    %esi,%eax
8010498e:	eb 15                	jmp    801049a5 <strncpy+0x25>
80104990:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104994:	8b 7d 0c             	mov    0xc(%ebp),%edi
80104997:	83 c0 01             	add    $0x1,%eax
8010499a:	0f b6 57 ff          	movzbl -0x1(%edi),%edx
8010499e:	88 50 ff             	mov    %dl,-0x1(%eax)
801049a1:	84 d2                	test   %dl,%dl
801049a3:	74 09                	je     801049ae <strncpy+0x2e>
801049a5:	89 cb                	mov    %ecx,%ebx
801049a7:	83 e9 01             	sub    $0x1,%ecx
801049aa:	85 db                	test   %ebx,%ebx
801049ac:	7f e2                	jg     80104990 <strncpy+0x10>
    ;
  while(n-- > 0)
801049ae:	89 c2                	mov    %eax,%edx
801049b0:	85 c9                	test   %ecx,%ecx
801049b2:	7e 17                	jle    801049cb <strncpy+0x4b>
801049b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    *s++ = 0;
801049b8:	83 c2 01             	add    $0x1,%edx
801049bb:	89 c1                	mov    %eax,%ecx
801049bd:	c6 42 ff 00          	movb   $0x0,-0x1(%edx)
  while(n-- > 0)
801049c1:	29 d1                	sub    %edx,%ecx
801049c3:	8d 4c 0b ff          	lea    -0x1(%ebx,%ecx,1),%ecx
801049c7:	85 c9                	test   %ecx,%ecx
801049c9:	7f ed                	jg     801049b8 <strncpy+0x38>
  return os;
}
801049cb:	5b                   	pop    %ebx
...
801049e7:	8b 75 08             	mov    0x8(%ebp),%esi
...
801049f0:	7e 25                	jle    80104a17 <safestrcpy+0x37>
801049f2:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
801049f6:	89 f2                	mov    %esi,%edx
801049f8:	eb 16                	jmp    80104a10 <safestrcpy+0x30>
...
80104a57:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104a5a:	e8 f1 ef ff ff       	call   80103a50 <myproc>
...
80104a97:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104a9a:	e8 b1 ef ff ff       	call   80103a50 <myproc>

  if(addr >= curproc->sz)
80104a9f:	39 18                	cmp    %ebx,(%eax)
80104aa1:	76 2d                	jbe    80104ad0 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
...
80104aac:	73 22                	jae    80104ad0 <fetchstr+0x40>
80104aae:	89 d8                	mov    %ebx,%eax
80104ab0:	eb 0d                	jmp    80104abf <fetchstr+0x2f>
80104ab2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104ab8:	83 c0 01             	add    $0x1,%eax
80104abb:	39 c2                	cmp    %eax,%edx
80104abd:	76 11                	jbe    80104ad0 <fetchstr+0x40>
    if(*s == 0)
80104abf:	80 38 00             	cmpb   $0x0,(%eax)
80104ac2:	75 f4                	jne    80104ab8 <fetchstr+0x28>
      return s - *pp;
...
80104b36:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104b39:	e8 12 ef ff ff       	call   80103a50 <myproc>
80104b3e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b40:	e8 0b ef ff ff       	call   80103a50 <myproc>
80104b45:	8b 55 08             	mov    0x8(%ebp),%edx
80104b48:	8b 40 18             	mov    0x18(%eax),%eax
80104b4b:	8b 40 44             	mov    0x44(%eax),%eax
80104b4e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b51:	e8 fa ee ff ff       	call   80103a50 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b56:	8d 7b 04             	lea    0x4(%ebx),%edi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104b59:	8b 00                	mov    (%eax),%eax
80104b5b:	39 c7                	cmp    %eax,%edi
80104b5d:	73 31                	jae    80104b90 <argptr+0x60>
80104b5f:	8d 4b 08             	lea    0x8(%ebx),%ecx
80104b62:	39 c8                	cmp    %ecx,%eax
80104b64:	72 2a                	jb     80104b90 <argptr+0x60>
 
  if(argint(n, &i) < 0)
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104b66:	8b 55 10             	mov    0x10(%ebp),%edx
  *ip = *(int*)(addr);
80104b69:	8b 43 04             	mov    0x4(%ebx),%eax
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104b6c:	85 d2                	test   %edx,%edx
80104b6e:	78 20                	js     80104b90 <argptr+0x60>
80104b70:	8b 16                	mov    (%esi),%edx
80104b72:	39 c2                	cmp    %eax,%edx
80104b74:	76 1a                	jbe    80104b90 <argptr+0x60>
80104b76:	8b 5d 10             	mov    0x10(%ebp),%ebx
80104b79:	01 c3                	add    %eax,%ebx
80104b7b:	39 da                	cmp    %ebx,%edx
80104b7d:	72 11                	jb     80104b90 <argptr+0x60>
    return -1;
  *pp = (char*)i;
...
80104b95:	eb ef                	jmp    80104b86 <argptr+0x56>
...
80104ba4:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ba5:	e8 a6 ee ff ff       	call   80103a50 <myproc>
...
80104bb3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104bb6:	e8 95 ee ff ff       	call   80103a50 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104bcb:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104bce:	e8 7d ee ff ff       	call   80103a50 <myproc>
  if(addr >= curproc->sz)
...
80104c24:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104c27:	e8 24 ee ff ff       	call   80103a50 <myproc>
...
80104c37:	83 fa 16             	cmp    $0x16,%edx
80104c3a:	77 24                	ja     80104c60 <syscall+0x40>
80104c3c:	8b 14 85 c0 7b 10 80 	mov    -0x7fef8440(,%eax,4),%edx
...
80104c68:	68 9d 7b 10 80       	push   $0x80107b9d
...
80104ca7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104caa:	e8 11 d4 ff ff       	call   801020c0 <nameiparent>
...
80104ccc:	e8 0f d0 ff ff       	call   80101ce0 <dirlookup>
...
80104ce6:	e8 95 ca ff ff       	call   80101780 <ilock>
...
80104d71:	e8 5a c9 ff ff       	call   801016d0 <iupdate>
...
80104d88:	e8 53 d2 ff ff       	call   80101fe0 <dirlink>
...
80104db9:	e8 12 c9 ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104dbe:	83 c4 0c             	add    $0xc,%esp
80104dc1:	ff 76 04             	push   0x4(%esi)
80104dc4:	68 3c 7c 10 80       	push   $0x80107c3c
80104dc9:	56                   	push   %esi
80104dca:	e8 11 d2 ff ff       	call   80101fe0 <dirlink>
...
80104ddc:	68 3b 7c 10 80       	push   $0x80107c3b
80104de1:	56                   	push   %esi
80104de2:	e8 f9 d1 ff ff       	call   80101fe0 <dirlink>
...
80104df1:	68 2f 7c 10 80       	push   $0x80107c2f
...
80104e0f:	68 3e 7c 10 80       	push   $0x80107c3e
80104e14:	e8 67 b5 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104e19:	83 ec 0c             	sub    $0xc,%esp
80104e1c:	68 20 7c 10 80       	push   $0x80107c20
...
80104e3e:	e8 9d fc ff ff       	call   80104ae0 <argint>
...
80104e50:	e8 fb eb ff ff       	call   80103a50 <myproc>
...
80104e5e:	74 20                	je     80104e80 <sys_dup+0x50>
  struct proc *curproc = myproc();
80104e60:	e8 eb eb ff ff       	call   80103a50 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104ebe:	e8 1d fc ff ff       	call   80104ae0 <argint>
...
80104ed0:	e8 7b eb ff ff       	call   80103a50 <myproc>
...
80104ee9:	e8 f2 fb ff ff       	call   80104ae0 <argint>
...
80104efe:	e8 2d fc ff ff       	call   80104b30 <argptr>
...
80104f14:	e8 07 c1 ff ff       	call   80101020 <fileread>
...
80104f3e:	e8 9d fb ff ff       	call   80104ae0 <argint>
...
80104f50:	e8 fb ea ff ff       	call   80103a50 <myproc>
...
80104f69:	e8 72 fb ff ff       	call   80104ae0 <argint>
...
80104f7e:	e8 ad fb ff ff       	call   80104b30 <argptr>
...
80104f94:	e8 17 c1 ff ff       	call   801010b0 <filewrite>
...
80104fbe:	e8 1d fb ff ff       	call   80104ae0 <argint>
...
80104fd0:	e8 7b ea ff ff       	call   80103a50 <myproc>
...
80104fe1:	74 25                	je     80105008 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104fe3:	e8 68 ea ff ff       	call   80103a50 <myproc>
  fileclose(f);
...
80104ff4:	e8 f7 be ff ff       	call   80100ef0 <fileclose>
  return 0;
...
8010501e:	e8 bd fa ff ff       	call   80104ae0 <argint>
...
80105030:	e8 1b ea ff ff       	call   80103a50 <myproc>
...
80105048:	e8 e3 fa ff ff       	call   80104b30 <argptr>
...
8010505b:	e8 70 bf ff ff       	call   80100fd0 <filestat>
...
801050b2:	0f 88 e2 00 00 00    	js     8010519a <sys_link+0x11a>
  begin_op();
801050b8:	e8 a3 dc ff ff       	call   80102d60 <begin_op>
  if((ip = namei(old)) == 0){
801050bd:	83 ec 0c             	sub    $0xc,%esp
801050c0:	ff 75 d4             	push   -0x2c(%ebp)
801050c3:	e8 d8 cf ff ff       	call   801020a0 <namei>
...
801050d9:	e8 a2 c6 ff ff       	call   80101780 <ilock>
  if(ip->type == T_DIR){
...
801050f8:	e8 d3 c5 ff ff       	call   801016d0 <iupdate>
  iunlock(ip);
801050fd:	89 1c 24             	mov    %ebx,(%esp)
80105100:	e8 5b c7 ff ff       	call   80101860 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105105:	58                   	pop    %eax
80105106:	5a                   	pop    %edx
80105107:	57                   	push   %edi
80105108:	ff 75 d0             	push   -0x30(%ebp)
8010510b:	e8 b0 cf ff ff       	call   801020c0 <nameiparent>
...
80105133:	e8 a8 ce ff ff       	call   80101fe0 <dirlink>
...
8010514b:	e8 60 c7 ff ff       	call   801018b0 <iput>
  end_op();
80105150:	e8 7b dc ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105185:	e8 46 c5 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
8010518a:	89 1c 24             	mov    %ebx,(%esp)
8010518d:	e8 7e c8 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105192:	e8 39 dc ff ff       	call   80102dd0 <end_op>
  return -1;
...
8010521d:	58                   	pop    %eax
8010521e:	5a                   	pop    %edx
8010521f:	68 3c 7c 10 80       	push   $0x80107c3c
80105224:	53                   	push   %ebx
80105225:	e8 96 ca ff ff       	call   80101cc0 <namecmp>
...
80105238:	68 3b 7c 10 80       	push   $0x80107c3b
8010523d:	53                   	push   %ebx
8010523e:	e8 7d ca ff ff       	call   80101cc0 <namecmp>
...
80105257:	e8 84 ca ff ff       	call   80101ce0 <dirlookup>
...
801052c2:	e8 49 c7 ff ff       	call   80101a10 <iunlockput>
  ip->nlink--;
801052c7:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801052cc:	89 1c 24             	mov    %ebx,(%esp)
801052cf:	e8 fc c3 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
801052d4:	89 1c 24             	mov    %ebx,(%esp)
801052d7:	e8 34 c7 ff ff       	call   80101a10 <iunlockput>
  end_op();
801052dc:	e8 ef da ff ff       	call   80102dd0 <end_op>
  return 0;
...
8010530d:	e8 7e c7 ff ff       	call   80101a90 <readi>
...
80105336:	e8 d5 c6 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010533b:	e8 90 da ff ff       	call   80102dd0 <end_op>
  return -1;
...
8010535c:	e8 6f c3 ff ff       	call   801016d0 <iupdate>
...
8010536e:	e9 73 ff ff ff       	jmp    801052e6 <sys_unlink+0x116>
    end_op();
80105373:	e8 58 da ff ff       	call   80102dd0 <end_op>
    return -1;
...
801053d8:	e8 03 f7 ff ff       	call   80104ae0 <argint>
...
801053e2:	78 79                	js     8010545d <sys_open+0xad>
  ...
  begin_op();
801053e4:	e8 77 d9 ff ff       	call   80102d60 <begin_op>
...
801053f5:	e8 a6 cc ff ff       	call   801020a0 <namei>
...
8010540b:	e8 70 c3 ff ff       	call   80101780 <ilock>
...
80105450:	e8 bb c5 ff ff       	call   80101a10 <iunlockput>
    end_op();
...
8010552f:	e8 dc c4 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105534:	e8 97 d8 ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105579:	e8 62 f5 ff ff       	call   80104ae0 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010558e:	e8 4d f5 ff ff       	call   80104ae0 <argint>
     argint(1, &major) < 0 ||
...
801055be:	e8 4d c4 ff ff       	call   80101a10 <iunlockput>
  end_op();
...
801055e5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801055e8:	e8 63 e4 ff ff       	call   80103a50 <myproc>
...
8010560f:	e8 8c ca ff ff       	call   801020a0 <namei>
...
80105621:	e8 5a c1 ff ff       	call   80101780 <ilock>
  if(ip->type != T_DIR){
...
80105634:	e8 27 c2 ff ff       	call   80101860 <iunlock>
  iput(curproc->cwd);
80105639:	58                   	pop    %eax
8010563a:	ff 76 68             	push   0x68(%esi)
8010563d:	e8 6e c2 ff ff       	call   801018b0 <iput>
  end_op();
80105642:	e8 89 d7 ff ff       	call   80102dd0 <end_op>
  curproc->cwd = ip;
...
80105664:	e8 a7 c3 ff ff       	call   80101a10 <iunlockput>
    end_op();
80105669:	e8 62 d7 ff ff       	call   80102dd0 <end_op>
    return -1;
...
801056c1:	e8 1a f4 ff ff       	call   80104ae0 <argint>
...
801056e0:	e8 3b f1 ff ff       	call   80104820 <memset>
...
8010570a:	e8 41 f3 ff ff       	call   80104a50 <fetchint>
...
80105728:	e8 63 f3 ff ff       	call   80104a90 <fetchstr>
...
80105791:	e8 9a f3 ff ff       	call   80104b30 <argptr>
...
801057a8:	e8 83 dc ff ff       	call   80103430 <pipealloc>
...
801057d6:	e8 15 b7 ff ff       	call   80100ef0 <fileclose>
    fileclose(wf);
801057db:	58                   	pop    %eax
801057dc:	ff 75 e4             	push   -0x1c(%ebp)
801057df:	e8 0c b7 ff ff       	call   80100ef0 <fileclose>
    return -1;
...
801057f7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801057fa:	e8 51 e2 ff ff       	call   80103a50 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105816:	75 f0                	jne    80105808 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105818:	e8 33 e2 ff ff       	call   80103a50 <myproc>
...
{
  return fork();
80105850:	e9 9b e3 ff ff       	jmp    80103bf0 <fork>
...
80105863:	83 ec 08             	sub    $0x8,%esp
  exit();
80105866:	e8 95 e6 ff ff       	call   80103f00 <exit>
...
{
  return wait();
80105870:	e9 7b e9 ff ff       	jmp    801041f0 <wait>
...
801058c3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801058c6:	e8 85 e1 ff ff       	call   80103a50 <myproc>
...
801058e7:	78 27                	js     80105910 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801058e9:	e8 62 e1 ff ff       	call   80103a50 <myproc>
  if(growproc(n) < 0)
...
801058f6:	e8 75 e2 ff ff       	call   80103b70 <growproc>
...
80105940:	68 a0 41 11 80       	push   $0x801141a0
80105945:	e8 16 ee ff ff       	call   80104760 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010594a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010594d:	8b 1d 80 41 11 80    	mov    0x80114180,%ebx
  while(ticks - ticks0 < n){
...
80105963:	68 a0 41 11 80       	push   $0x801141a0
80105968:	68 80 41 11 80       	push   $0x80114180
8010596d:	e8 ee e6 ff ff       	call   80104060 <sleep>
  while(ticks - ticks0 < n){
80105972:	a1 80 41 11 80       	mov    0x80114180,%eax
...
8010597f:	73 2f                	jae    801059b0 <sys_sleep+0x90>
    if(myproc()->killed){
80105981:	e8 ca e0 ff ff       	call   80103a50 <myproc>
...
80105990:	68 a0 41 11 80       	push   $0x801141a0
...
801059b3:	68 a0 41 11 80       	push   $0x801141a0
...
801059d4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059d7:	68 a0 41 11 80       	push   $0x801141a0
801059dc:	e8 7f ed ff ff       	call   80104760 <acquire>
  xticks = ticks;
801059e1:	8b 1d 80 41 11 80    	mov    0x80114180,%ebx
  release(&tickslock);
801059e7:	c7 04 24 a0 41 11 80 	movl   $0x801141a0,(%esp)
...
80105a04:	56                   	push   %esi
  int n;
  if(argint(0, &n) < 0)
80105a05:	8d 45 e4             	lea    -0x1c(%ebp),%eax
{
...
80105a0f:	e8 cc f0 ff ff       	call   80104ae0 <argint>
80105a14:	83 c4 10             	add    $0x10,%esp
80105a17:	85 c0                	test   %eax,%eax
80105a19:	0f 88 8a 00 00 00    	js     80105aa9 <sys_settickets+0xa9>
    return -1;
  if(n < 1)
80105a1f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105a22:	85 c0                	test   %eax,%eax
80105a24:	7e 7a                	jle    80105aa0 <sys_settickets+0xa0>
    n = DEFAULT_TICKETS;
  else if(n > MAX_TICKETS)
80105a26:	83 f8 20             	cmp    $0x20,%eax
80105a29:	7f 65                	jg     80105a90 <sys_settickets+0x90>
    n = MAX_TICKETS;

  struct proc *curproc = myproc();
80105a2b:	e8 20 e0 ff ff       	call   80103a50 <myproc>
...
80105a30:	83 ec 0c             	sub    $0xc,%esp
  ...
  global_tickets += curproc->tickets;
  global_stride = STRIDE1 / global_tickets;
80105a33:	bf 00 04 00 00       	mov    $0x400,%edi
  acquire(&ptable.lock);
80105a38:	68 20 1d 11 80       	push   $0x80111d20
  struct proc *curproc = myproc();
80105a3d:	89 c3                	mov    %eax,%ebx
  acquire(&ptable.lock);
80105a3f:	e8 1c ed ff ff       	call   80104760 <acquire>
  curproc->tickets = n;
80105a44:	8b 75 e4             	mov    -0x1c(%ebp),%esi
  global_tickets -= curproc->tickets;
80105a47:	8b 0d 5c 41 11 80    	mov    0x8011415c,%ecx
  global_stride = STRIDE1 / global_tickets;
80105a4d:	89 f8                	mov    %edi,%eax
  global_tickets -= curproc->tickets;
80105a4f:	2b 4b 7c             	sub    0x7c(%ebx),%ecx
  global_stride = STRIDE1 / global_tickets;
80105a52:	99                   	cltd   
  global_tickets += curproc->tickets;
80105a53:	01 f1                	add    %esi,%ecx
  curproc->tickets = n;
80105a55:	89 73 7c             	mov    %esi,0x7c(%ebx)
  global_stride = STRIDE1 / global_tickets;
80105a58:	f7 f9                	idiv   %ecx
  global_tickets += curproc->tickets;
80105a5a:	89 0d 5c 41 11 80    	mov    %ecx,0x8011415c
  global_stride = STRIDE1 / global_tickets;
80105a60:	a3 58 41 11 80       	mov    %eax,0x80114158
  // 更新进程的 stride
  curproc->stride = STRIDE1 / curproc->tickets;
80105a65:	89 f8                	mov    %edi,%eax
80105a67:	99                   	cltd   
80105a68:	f7 fe                	idiv   %esi
80105a6a:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
  release(&ptable.lock);
80105a70:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80105a77:	e8 84 ec ff ff       	call   80104700 <release>
...
80105a89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    n = MAX_TICKETS;
80105a90:	c7 45 e4 20 00 00 00 	movl   $0x20,-0x1c(%ebp)
80105a97:	eb 92                	jmp    80105a2b <sys_settickets+0x2b>
80105a99:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    n = DEFAULT_TICKETS;
80105aa0:	c7 45 e4 08 00 00 00 	movl   $0x8,-0x1c(%ebp)
80105aa7:	eb 82                	jmp    80105a2b <sys_settickets+0x2b>
    return -1;
80105aa9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105aae:	eb d1                	jmp    80105a81 <sys_settickets+0x81>

80105ab0 <sys_getpinfo>:
...
{
80105ab8:	83 ec 14             	sub    $0x14,%esp
  if(argptr(0, (void*)&ps, sizeof(*ps)) < 0)
80105abb:	68 00 07 00 00       	push   $0x700
80105ac0:	50                   	push   %eax
80105ac1:	6a 00                	push   $0x0
80105ac3:	e8 68 f0 ff ff       	call   80104b30 <argptr>
80105ac8:	83 c4 10             	add    $0x10,%esp
80105acb:	85 c0                	test   %eax,%eax
80105acd:	0f 88 8e 00 00 00    	js     80105b61 <sys_getpinfo+0xb1>
    return -1;
...
80105ad6:	68 20 1d 11 80       	push   $0x80111d20
80105adb:	e8 80 ec ff ff       	call   80104760 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++, i++){
    ps->inuse[i] = (p->state != UNUSED);
80105ae0:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80105ae3:	83 c4 10             	add    $0x10,%esp
  int i = 0;
80105ae6:	31 c9                	xor    %ecx,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++, i++){
80105ae8:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80105aed:	8d 76 00             	lea    0x0(%esi),%esi
    ps->inuse[i] = (p->state != UNUSED);
80105af0:	8b 70 0c             	mov    0xc(%eax),%esi
80105af3:	31 d2                	xor    %edx,%edx
80105af5:	85 f6                	test   %esi,%esi
80105af7:	0f 95 c2             	setne  %dl
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++, i++){
80105afa:	05 90 00 00 00       	add    $0x90,%eax
    ps->inuse[i] = (p->state != UNUSED);
80105aff:	89 14 8b             	mov    %edx,(%ebx,%ecx,4)
    ps->tickets[i] = p->tickets;
80105b02:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80105b05:	8b 70 ec             	mov    -0x14(%eax),%esi
80105b08:	8d 14 8b             	lea    (%ebx,%ecx,4),%edx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++, i++){
80105b0b:	83 c1 01             	add    $0x1,%ecx
    ps->tickets[i] = p->tickets;
80105b0e:	89 b2 00 01 00 00    	mov    %esi,0x100(%edx)
    ps->pid[i] = p->pid;
80105b14:	8b 70 80             	mov    -0x80(%eax),%esi
80105b17:	89 b2 00 02 00 00    	mov    %esi,0x200(%edx)
    ps->pass[i] = p->pass;
80105b1d:	8b 70 f4             	mov    -0xc(%eax),%esi
80105b20:	89 b2 00 03 00 00    	mov    %esi,0x300(%edx)
    ps->remain[i] = p->remain;
80105b26:	8b 70 f8             	mov    -0x8(%eax),%esi
80105b29:	89 b2 00 04 00 00    	mov    %esi,0x400(%edx)
    ps->stride[i] = p->stride;
80105b2f:	8b 70 f0             	mov    -0x10(%eax),%esi
80105b32:	89 b2 00 05 00 00    	mov    %esi,0x500(%edx)
    ps->rtime[i] = p->rtime;
80105b38:	8b 70 fc             	mov    -0x4(%eax),%esi
80105b3b:	89 b2 00 06 00 00    	mov    %esi,0x600(%edx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++, i++){
80105b41:	3d 54 41 11 80       	cmp    $0x80114154,%eax
80105b46:	75 a8                	jne    80105af0 <sys_getpinfo+0x40>
  }
  release(&ptable.lock);
80105b48:	83 ec 0c             	sub    $0xc,%esp
80105b4b:	68 20 1d 11 80       	push   $0x80111d20
80105b50:	e8 ab eb ff ff       	call   80104700 <release>

  return 0;
80105b55:	83 c4 10             	add    $0x10,%esp
80105b58:	31 c0                	xor    %eax,%eax
}
80105b5a:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105b5d:	5b                   	pop    %ebx
80105b5e:	5e                   	pop    %esi
80105b5f:	5d                   	pop    %ebp
80105b60:	c3                   	ret    
...
80105b66:	eb f2                	jmp    80105b5a <sys_getpinfo+0xaa>
...
80105b69:	06                   	push   %es
  pushl %fs
80105b6a:	0f a0                	push   %fs
  pushl %gs
80105b6c:	0f a8                	push   %gs
  pushal
80105b6e:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105b6f:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105b73:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105b75:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105b77:	54                   	push   %esp
  call trap
80105b78:	e8 c3 00 00 00       	call   80105c40 <trap>
  addl $4, %esp
80105b7d:	83 c4 04             	add    $0x4,%esp
...
80105b80:	61                   	popa   
  popl %gs
80105b81:	0f a9                	pop    %gs
  popl %fs
80105b83:	0f a1                	pop    %fs
  popl %es
80105b85:	07                   	pop    %es
  popl %ds
80105b86:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105b87:	83 c4 08             	add    $0x8,%esp
  iret
80105b8a:	cf                   	iret   
...
80105bde:	00 00 ef 
  initlock(&tickslock, "time");
80105be1:	68 81 7c 10 80       	push   $0x80107c81
...
80105bf4:	66 a3 e6 43 11 80    	mov    %ax,0x801143e6
  initlock(&tickslock, "time");
80105bfa:	e8 91 e9 ff ff       	call   80104590 <initlock>
}
...
80105c64:	ff 24 85 28 7d 10 80 	jmp    *-0x7fef82d8(,%eax,4)
...
80105c83:	e8 c8 dd ff ff       	call   80103a50 <myproc>
...
80105c9a:	0f 84 e0 01 00 00    	je     80105e80 <trap+0x240>
    exit();
...
80105ca9:	e8 a2 dd ff ff       	call   80103a50 <myproc>
...
80105cb2:	0f 84 b8 00 00 00    	je     80105d70 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cb8:	e8 93 dd ff ff       	call   80103a50 <myproc>
80105cbd:	85 c0                	test   %eax,%eax
80105cbf:	74 1d                	je     80105cde <trap+0x9e>
80105cc1:	e8 8a dd ff ff       	call   80103a50 <myproc>
...
80105cf0:	e8 5b dd ff ff       	call   80103a50 <myproc>
80105cf5:	8b 7b 38             	mov    0x38(%ebx),%edi
80105cf8:	85 c0                	test   %eax,%eax
80105cfa:	0f 84 d2 01 00 00    	je     80105ed2 <trap+0x292>
80105d00:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105d04:	0f 84 c8 01 00 00    	je     80105ed2 <trap+0x292>
...
80105d10:	e8 1b dd ff ff       	call   80103a30 <cpuid>
...
80105d21:	e8 2a dd ff ff       	call   80103a50 <myproc>
80105d26:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105d29:	e8 22 dd ff ff       	call   80103a50 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105d45:	68 e4 7c 10 80       	push   $0x80107ce4
80105d4a:	e8 51 a9 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105d4f:	83 c4 20             	add    $0x20,%esp
80105d52:	e8 f9 dc ff ff       	call   80103a50 <myproc>
80105d57:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d5e:	e8 ed dc ff ff       	call   80103a50 <myproc>
...
80105d74:	0f 85 3e ff ff ff    	jne    80105cb8 <trap+0x78>
    yield();
80105d7a:	e8 91 e2 ff ff       	call   80104010 <yield>
...
80105d8f:	e8 9c dc ff ff       	call   80103a30 <cpuid>
80105d94:	57                   	push   %edi
80105d95:	56                   	push   %esi
80105d96:	50                   	push   %eax
80105d97:	68 8c 7c 10 80       	push   $0x80107c8c
...
80105da6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105da9:	e8 a2 dc ff ff       	call   80103a50 <myproc>
...
80105dbf:	90                   	nop
    if(myproc()->killed)
80105dc0:	e8 8b dc ff ff       	call   80103a50 <myproc>
80105dc5:	8b 70 24             	mov    0x24(%eax),%esi
80105dc8:	85 f6                	test   %esi,%esi
80105dca:	0f 85 f8 00 00 00    	jne    80105ec8 <trap+0x288>
    myproc()->tf = tf;
80105dd0:	e8 7b dc ff ff       	call   80103a50 <myproc>
80105dd5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105dd8:	e8 43 ee ff ff       	call   80104c20 <syscall>
    if(myproc()->killed)
80105ddd:	e8 6e dc ff ff       	call   80103a50 <myproc>
...
80105df3:	5d                   	pop    %ebp
      exit();
80105df4:	e9 07 e1 ff ff       	jmp    80103f00 <exit>
80105df9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105e00:	e8 6b 02 00 00       	call   80106070 <uartintr>
    lapiceoi();
80105e05:	e8 06 cb ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e0a:	e8 41 dc ff ff       	call   80103a50 <myproc>
...
80105e25:	e8 e6 ca ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e2a:	e8 21 dc ff ff       	call   80103a50 <myproc>
...
80105e3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105e40:	e8 eb db ff ff       	call   80103a30 <cpuid>
80105e45:	85 c0                	test   %eax,%eax
80105e47:	74 47                	je     80105e90 <trap+0x250>
    if(myproc() && myproc()->state == RUNNING) {
80105e49:	e8 02 dc ff ff       	call   80103a50 <myproc>
80105e4e:	85 c0                	test   %eax,%eax
80105e50:	0f 84 1f fe ff ff    	je     80105c75 <trap+0x35>
80105e56:	e8 f5 db ff ff       	call   80103a50 <myproc>
80105e5b:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105e5f:	0f 85 10 fe ff ff    	jne    80105c75 <trap+0x35>
      myproc()->rtime++;  // 每个时间片增加一次运行时间
80105e65:	e8 e6 db ff ff       	call   80103a50 <myproc>
80105e6a:	83 80 8c 00 00 00 01 	addl   $0x1,0x8c(%eax)
    lapiceoi();
80105e71:	e9 ff fd ff ff       	jmp    80105c75 <trap+0x35>
80105e76:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105e7d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105e80:	e8 7b e0 ff ff       	call   80103f00 <exit>
80105e85:	e9 16 fe ff ff       	jmp    80105ca0 <trap+0x60>
80105e8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105e90:	83 ec 0c             	sub    $0xc,%esp
80105e93:	68 a0 41 11 80       	push   $0x801141a0
80105e98:	e8 c3 e8 ff ff       	call   80104760 <acquire>
      wakeup(&ticks);
80105e9d:	c7 04 24 80 41 11 80 	movl   $0x80114180,(%esp)
      ticks++;
80105ea4:	83 05 80 41 11 80 01 	addl   $0x1,0x80114180
      wakeup(&ticks);
80105eab:	e8 40 e4 ff ff       	call   801042f0 <wakeup>
      release(&tickslock);
80105eb0:	c7 04 24 a0 41 11 80 	movl   $0x801141a0,(%esp)
80105eb7:	e8 44 e8 ff ff       	call   80104700 <release>
80105ebc:	83 c4 10             	add    $0x10,%esp
80105ebf:	eb 88                	jmp    80105e49 <trap+0x209>
80105ec1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      exit();
80105ec8:	e8 33 e0 ff ff       	call   80103f00 <exit>
80105ecd:	e9 fe fe ff ff       	jmp    80105dd0 <trap+0x190>
80105ed2:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105ed5:	e8 56 db ff ff       	call   80103a30 <cpuid>
...
{
  if(!uart)
80105f00:	a1 e0 49 11 80       	mov    0x801149e0,%eax
...
80105f87:	74 78                	je     80106001 <uartinit+0xd1>
  uart = 1;
80105f89:	c7 05 e0 49 11 80 01 	movl   $0x1,0x801149e0
80105f90:	00 00 00 
...
80105fb9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105fc0:	a1 e0 49 11 80       	mov    0x801149e0,%eax
...
80106010 <uartputc>:
  if(!uart)
80106010:	a1 e0 49 11 80       	mov    0x801149e0,%eax
...
80106087:	6a 00                	push   $0x0
  jmp alltraps
80106089:	e9 da fa ff ff       	jmp    80105b68 <alltraps>
...
80106090:	6a 01                	push   $0x1
  jmp alltraps
80106092:	e9 d1 fa ff ff       	jmp    80105b68 <alltraps>
...
80106099:	6a 02                	push   $0x2
  jmp alltraps
8010609b:	e9 c8 fa ff ff       	jmp    80105b68 <alltraps>
...
801060a2:	6a 03                	push   $0x3
  jmp alltraps
801060a4:	e9 bf fa ff ff       	jmp    80105b68 <alltraps>
...
801060ab:	6a 04                	push   $0x4
  jmp alltraps
801060ad:	e9 b6 fa ff ff       	jmp    80105b68 <alltraps>
...
801060b4:	6a 05                	push   $0x5
  jmp alltraps
801060b6:	e9 ad fa ff ff       	jmp    80105b68 <alltraps>
...
801060bd:	6a 06                	push   $0x6
  jmp alltraps
801060bf:	e9 a4 fa ff ff       	jmp    80105b68 <alltraps>
...
801060c6:	6a 07                	push   $0x7
  jmp alltraps
801060c8:	e9 9b fa ff ff       	jmp    80105b68 <alltraps>
...
801060cd:	6a 08                	push   $0x8
  jmp alltraps
801060cf:	e9 94 fa ff ff       	jmp    80105b68 <alltraps>
...
801060d6:	6a 09                	push   $0x9
  jmp alltraps
801060d8:	e9 8b fa ff ff       	jmp    80105b68 <alltraps>
...
801060dd:	6a 0a                	push   $0xa
  jmp alltraps
801060df:	e9 84 fa ff ff       	jmp    80105b68 <alltraps>
...
801060e4:	6a 0b                	push   $0xb
  jmp alltraps
801060e6:	e9 7d fa ff ff       	jmp    80105b68 <alltraps>
...
801060eb:	6a 0c                	push   $0xc
  jmp alltraps
801060ed:	e9 76 fa ff ff       	jmp    80105b68 <alltraps>
...
801060f2:	6a 0d                	push   $0xd
  jmp alltraps
801060f4:	e9 6f fa ff ff       	jmp    80105b68 <alltraps>
...
801060f9:	6a 0e                	push   $0xe
  jmp alltraps
801060fb:	e9 68 fa ff ff       	jmp    80105b68 <alltraps>
...
80106102:	6a 0f                	push   $0xf
  jmp alltraps
80106104:	e9 5f fa ff ff       	jmp    80105b68 <alltraps>
...
8010610b:	6a 10                	push   $0x10
  jmp alltraps
8010610d:	e9 56 fa ff ff       	jmp    80105b68 <alltraps>
...
80106112:	6a 11                	push   $0x11
  jmp alltraps
80106114:	e9 4f fa ff ff       	jmp    80105b68 <alltraps>
...
8010611b:	6a 12                	push   $0x12
  jmp alltraps
8010611d:	e9 46 fa ff ff       	jmp    80105b68 <alltraps>
...
80106124:	6a 13                	push   $0x13
  jmp alltraps
80106126:	e9 3d fa ff ff       	jmp    80105b68 <alltraps>
...
8010612d:	6a 14                	push   $0x14
  jmp alltraps
8010612f:	e9 34 fa ff ff       	jmp    80105b68 <alltraps>
...
80106136:	6a 15                	push   $0x15
  jmp alltraps
80106138:	e9 2b fa ff ff       	jmp    80105b68 <alltraps>
...
8010613f:	6a 16                	push   $0x16
  jmp alltraps
80106141:	e9 22 fa ff ff       	jmp    80105b68 <alltraps>
...
80106148:	6a 17                	push   $0x17
  jmp alltraps
8010614a:	e9 19 fa ff ff       	jmp    80105b68 <alltraps>
...
80106151:	6a 18                	push   $0x18
  jmp alltraps
80106153:	e9 10 fa ff ff       	jmp    80105b68 <alltraps>
...
8010615a:	6a 19                	push   $0x19
  jmp alltraps
8010615c:	e9 07 fa ff ff       	jmp    80105b68 <alltraps>
...
80106163:	6a 1a                	push   $0x1a
  jmp alltraps
80106165:	e9 fe f9 ff ff       	jmp    80105b68 <alltraps>
...
8010616c:	6a 1b                	push   $0x1b
  jmp alltraps
8010616e:	e9 f5 f9 ff ff       	jmp    80105b68 <alltraps>
...
80106175:	6a 1c                	push   $0x1c
  jmp alltraps
80106177:	e9 ec f9 ff ff       	jmp    80105b68 <alltraps>
...
8010617e:	6a 1d                	push   $0x1d
  jmp alltraps
80106180:	e9 e3 f9 ff ff       	jmp    80105b68 <alltraps>
...
80106187:	6a 1e                	push   $0x1e
  jmp alltraps
80106189:	e9 da f9 ff ff       	jmp    80105b68 <alltraps>
...
80106190:	6a 1f                	push   $0x1f
  jmp alltraps
80106192:	e9 d1 f9 ff ff       	jmp    80105b68 <alltraps>
...
80106199:	6a 20                	push   $0x20
  jmp alltraps
8010619b:	e9 c8 f9 ff ff       	jmp    80105b68 <alltraps>
...
801061a2:	6a 21                	push   $0x21
  jmp alltraps
801061a4:	e9 bf f9 ff ff       	jmp    80105b68 <alltraps>
...
801061ab:	6a 22                	push   $0x22
  jmp alltraps
801061ad:	e9 b6 f9 ff ff       	jmp    80105b68 <alltraps>
...
801061b4:	6a 23                	push   $0x23
  jmp alltraps
801061b6:	e9 ad f9 ff ff       	jmp    80105b68 <alltraps>
...
801061bd:	6a 24                	push   $0x24
  jmp alltraps
801061bf:	e9 a4 f9 ff ff       	jmp    80105b68 <alltraps>
...
801061c6:	6a 25                	push   $0x25
  jmp alltraps
801061c8:	e9 9b f9 ff ff       	jmp    80105b68 <alltraps>
...
801061cf:	6a 26                	push   $0x26
  jmp alltraps
801061d1:	e9 92 f9 ff ff       	jmp    80105b68 <alltraps>
...
801061d8:	6a 27                	push   $0x27
  jmp alltraps
801061da:	e9 89 f9 ff ff       	jmp    80105b68 <alltraps>
...
801061e1:	6a 28                	push   $0x28
  jmp alltraps
801061e3:	e9 80 f9 ff ff       	jmp    80105b68 <alltraps>
...
801061ea:	6a 29                	push   $0x29
  jmp alltraps
801061ec:	e9 77 f9 ff ff       	jmp    80105b68 <alltraps>
...
801061f3:	6a 2a                	push   $0x2a
  jmp alltraps
801061f5:	e9 6e f9 ff ff       	jmp    80105b68 <alltraps>
...
801061fc:	6a 2b                	push   $0x2b
  jmp alltraps
801061fe:	e9 65 f9 ff ff       	jmp    80105b68 <alltraps>
...
80106205:	6a 2c                	push   $0x2c
  jmp alltraps
80106207:	e9 5c f9 ff ff       	jmp    80105b68 <alltraps>
...
8010620e:	6a 2d                	push   $0x2d
  jmp alltraps
80106210:	e9 53 f9 ff ff       	jmp    80105b68 <alltraps>
...
80106217:	6a 2e                	push   $0x2e
  jmp alltraps
80106219:	e9 4a f9 ff ff       	jmp    80105b68 <alltraps>
...
80106220:	6a 2f                	push   $0x2f
  jmp alltraps
80106222:	e9 41 f9 ff ff       	jmp    80105b68 <alltraps>
...
80106229:	6a 30                	push   $0x30
  jmp alltraps
8010622b:	e9 38 f9 ff ff       	jmp    80105b68 <alltraps>
...
80106232:	6a 31                	push   $0x31
  jmp alltraps
80106234:	e9 2f f9 ff ff       	jmp    80105b68 <alltraps>
...
8010623b:	6a 32                	push   $0x32
  jmp alltraps
8010623d:	e9 26 f9 ff ff       	jmp    80105b68 <alltraps>
...
80106244:	6a 33                	push   $0x33
  jmp alltraps
80106246:	e9 1d f9 ff ff       	jmp    80105b68 <alltraps>
...
8010624d:	6a 34                	push   $0x34
  jmp alltraps
8010624f:	e9 14 f9 ff ff       	jmp    80105b68 <alltraps>
...
80106256:	6a 35                	push   $0x35
  jmp alltraps
80106258:	e9 0b f9 ff ff       	jmp    80105b68 <alltraps>
...
8010625f:	6a 36                	push   $0x36
  jmp alltraps
80106261:	e9 02 f9 ff ff       	jmp    80105b68 <alltraps>
...
80106268:	6a 37                	push   $0x37
  jmp alltraps
8010626a:	e9 f9 f8 ff ff       	jmp    80105b68 <alltraps>
...
80106271:	6a 38                	push   $0x38
  jmp alltraps
80106273:	e9 f0 f8 ff ff       	jmp    80105b68 <alltraps>
...
8010627a:	6a 39                	push   $0x39
  jmp alltraps
8010627c:	e9 e7 f8 ff ff       	jmp    80105b68 <alltraps>
...
80106283:	6a 3a                	push   $0x3a
  jmp alltraps
80106285:	e9 de f8 ff ff       	jmp    80105b68 <alltraps>
...
8010628c:	6a 3b                	push   $0x3b
  jmp alltraps
8010628e:	e9 d5 f8 ff ff       	jmp    80105b68 <alltraps>
...
80106295:	6a 3c                	push   $0x3c
  jmp alltraps
80106297:	e9 cc f8 ff ff       	jmp    80105b68 <alltraps>
...
8010629e:	6a 3d                	push   $0x3d
  jmp alltraps
801062a0:	e9 c3 f8 ff ff       	jmp    80105b68 <alltraps>
...
801062a7:	6a 3e                	push   $0x3e
  jmp alltraps
801062a9:	e9 ba f8 ff ff       	jmp    80105b68 <alltraps>
...
801062b0:	6a 3f                	push   $0x3f
  jmp alltraps
801062b2:	e9 b1 f8 ff ff       	jmp    80105b68 <alltraps>
...
801062b9:	6a 40                	push   $0x40
  jmp alltraps
801062bb:	e9 a8 f8 ff ff       	jmp    80105b68 <alltraps>
...
801062c2:	6a 41                	push   $0x41
  jmp alltraps
801062c4:	e9 9f f8 ff ff       	jmp    80105b68 <alltraps>
...
801062cb:	6a 42                	push   $0x42
  jmp alltraps
801062cd:	e9 96 f8 ff ff       	jmp    80105b68 <alltraps>
...
801062d4:	6a 43                	push   $0x43
  jmp alltraps
801062d6:	e9 8d f8 ff ff       	jmp    80105b68 <alltraps>
...
801062dd:	6a 44                	push   $0x44
  jmp alltraps
801062df:	e9 84 f8 ff ff       	jmp    80105b68 <alltraps>
...
801062e6:	6a 45                	push   $0x45
  jmp alltraps
801062e8:	e9 7b f8 ff ff       	jmp    80105b68 <alltraps>
...
801062ef:	6a 46                	push   $0x46
  jmp alltraps
801062f1:	e9 72 f8 ff ff       	jmp    80105b68 <alltraps>
...
801062f8:	6a 47                	push   $0x47
  jmp alltraps
801062fa:	e9 69 f8 ff ff       	jmp    80105b68 <alltraps>
...
80106301:	6a 48                	push   $0x48
  jmp alltraps
80106303:	e9 60 f8 ff ff       	jmp    80105b68 <alltraps>
...
8010630a:	6a 49                	push   $0x49
  jmp alltraps
8010630c:	e9 57 f8 ff ff       	jmp    80105b68 <alltraps>
...
80106313:	6a 4a                	push   $0x4a
  jmp alltraps
80106315:	e9 4e f8 ff ff       	jmp    80105b68 <alltraps>
...
8010631c:	6a 4b                	push   $0x4b
  jmp alltraps
8010631e:	e9 45 f8 ff ff       	jmp    80105b68 <alltraps>
...
80106325:	6a 4c                	push   $0x4c
  jmp alltraps
80106327:	e9 3c f8 ff ff       	jmp    80105b68 <alltraps>
...
8010632e:	6a 4d                	push   $0x4d
  jmp alltraps
80106330:	e9 33 f8 ff ff       	jmp    80105b68 <alltraps>
...
80106337:	6a 4e                	push   $0x4e
  jmp alltraps
80106339:	e9 2a f8 ff ff       	jmp    80105b68 <alltraps>
...
80106340:	6a 4f                	push   $0x4f
  jmp alltraps
80106342:	e9 21 f8 ff ff       	jmp    80105b68 <alltraps>
...
80106349:	6a 50                	push   $0x50
  jmp alltraps
8010634b:	e9 18 f8 ff ff       	jmp    80105b68 <alltraps>
...
80106352:	6a 51                	push   $0x51
  jmp alltraps
80106354:	e9 0f f8 ff ff       	jmp    80105b68 <alltraps>
...
8010635b:	6a 52                	push   $0x52
  jmp alltraps
8010635d:	e9 06 f8 ff ff       	jmp    80105b68 <alltraps>
...
80106364:	6a 53                	push   $0x53
  jmp alltraps
80106366:	e9 fd f7 ff ff       	jmp    80105b68 <alltraps>
...
8010636d:	6a 54                	push   $0x54
  jmp alltraps
8010636f:	e9 f4 f7 ff ff       	jmp    80105b68 <alltraps>
...
80106376:	6a 55                	push   $0x55
  jmp alltraps
80106378:	e9 eb f7 ff ff       	jmp    80105b68 <alltraps>
...
8010637f:	6a 56                	push   $0x56
  jmp alltraps
80106381:	e9 e2 f7 ff ff       	jmp    80105b68 <alltraps>
...
80106388:	6a 57                	push   $0x57
  jmp alltraps
8010638a:	e9 d9 f7 ff ff       	jmp    80105b68 <alltraps>
...
80106391:	6a 58                	push   $0x58
  jmp alltraps
80106393:	e9 d0 f7 ff ff       	jmp    80105b68 <alltraps>
...
8010639a:	6a 59                	push   $0x59
  jmp alltraps
8010639c:	e9 c7 f7 ff ff       	jmp    80105b68 <alltraps>
...
801063a3:	6a 5a                	push   $0x5a
  jmp alltraps
801063a5:	e9 be f7 ff ff       	jmp    80105b68 <alltraps>
...
801063ac:	6a 5b                	push   $0x5b
  jmp alltraps
801063ae:	e9 b5 f7 ff ff       	jmp    80105b68 <alltraps>
...
801063b5:	6a 5c                	push   $0x5c
  jmp alltraps
801063b7:	e9 ac f7 ff ff       	jmp    80105b68 <alltraps>
...
801063be:	6a 5d                	push   $0x5d
  jmp alltraps
801063c0:	e9 a3 f7 ff ff       	jmp    80105b68 <alltraps>
...
801063c7:	6a 5e                	push   $0x5e
  jmp alltraps
801063c9:	e9 9a f7 ff ff       	jmp    80105b68 <alltraps>
...
801063d0:	6a 5f                	push   $0x5f
  jmp alltraps
801063d2:	e9 91 f7 ff ff       	jmp    80105b68 <alltraps>
...
801063d9:	6a 60                	push   $0x60
  jmp alltraps
801063db:	e9 88 f7 ff ff       	jmp    80105b68 <alltraps>
...
801063e2:	6a 61                	push   $0x61
  jmp alltraps
801063e4:	e9 7f f7 ff ff       	jmp    80105b68 <alltraps>
...
801063eb:	6a 62                	push   $0x62
  jmp alltraps
801063ed:	e9 76 f7 ff ff       	jmp    80105b68 <alltraps>
...
801063f4:	6a 63                	push   $0x63
  jmp alltraps
801063f6:	e9 6d f7 ff ff       	jmp    80105b68 <alltraps>
...
801063fd:	6a 64                	push   $0x64
  jmp alltraps
801063ff:	e9 64 f7 ff ff       	jmp    80105b68 <alltraps>
...
80106406:	6a 65                	push   $0x65
  jmp alltraps
80106408:	e9 5b f7 ff ff       	jmp    80105b68 <alltraps>
...
8010640f:	6a 66                	push   $0x66
  jmp alltraps
80106411:	e9 52 f7 ff ff       	jmp    80105b68 <alltraps>
...
80106418:	6a 67                	push   $0x67
  jmp alltraps
8010641a:	e9 49 f7 ff ff       	jmp    80105b68 <alltraps>
...
80106421:	6a 68                	push   $0x68
  jmp alltraps
80106423:	e9 40 f7 ff ff       	jmp    80105b68 <alltraps>
...
8010642a:	6a 69                	push   $0x69
  jmp alltraps
8010642c:	e9 37 f7 ff ff       	jmp    80105b68 <alltraps>
...
80106433:	6a 6a                	push   $0x6a
  jmp alltraps
80106435:	e9 2e f7 ff ff       	jmp    80105b68 <alltraps>
...
8010643c:	6a 6b                	push   $0x6b
  jmp alltraps
8010643e:	e9 25 f7 ff ff       	jmp    80105b68 <alltraps>
...
80106445:	6a 6c                	push   $0x6c
  jmp alltraps
80106447:	e9 1c f7 ff ff       	jmp    80105b68 <alltraps>
...
8010644e:	6a 6d                	push   $0x6d
  jmp alltraps
80106450:	e9 13 f7 ff ff       	jmp    80105b68 <alltraps>
...
80106457:	6a 6e                	push   $0x6e
  jmp alltraps
80106459:	e9 0a f7 ff ff       	jmp    80105b68 <alltraps>
...
80106460:	6a 6f                	push   $0x6f
  jmp alltraps
80106462:	e9 01 f7 ff ff       	jmp    80105b68 <alltraps>
...
80106469:	6a 70                	push   $0x70
  jmp alltraps
8010646b:	e9 f8 f6 ff ff       	jmp    80105b68 <alltraps>
...
80106472:	6a 71                	push   $0x71
  jmp alltraps
80106474:	e9 ef f6 ff ff       	jmp    80105b68 <alltraps>
...
8010647b:	6a 72                	push   $0x72
  jmp alltraps
8010647d:	e9 e6 f6 ff ff       	jmp    80105b68 <alltraps>
...
80106484:	6a 73                	push   $0x73
  jmp alltraps
80106486:	e9 dd f6 ff ff       	jmp    80105b68 <alltraps>
...
8010648d:	6a 74                	push   $0x74
  jmp alltraps
8010648f:	e9 d4 f6 ff ff       	jmp    80105b68 <alltraps>
...
80106496:	6a 75                	push   $0x75
  jmp alltraps
80106498:	e9 cb f6 ff ff       	jmp    80105b68 <alltraps>
...
8010649f:	6a 76                	push   $0x76
  jmp alltraps
801064a1:	e9 c2 f6 ff ff       	jmp    80105b68 <alltraps>
...
801064a8:	6a 77                	push   $0x77
  jmp alltraps
801064aa:	e9 b9 f6 ff ff       	jmp    80105b68 <alltraps>
...
801064b1:	6a 78                	push   $0x78
  jmp alltraps
801064b3:	e9 b0 f6 ff ff       	jmp    80105b68 <alltraps>
...
801064ba:	6a 79                	push   $0x79
  jmp alltraps
801064bc:	e9 a7 f6 ff ff       	jmp    80105b68 <alltraps>
...
801064c3:	6a 7a                	push   $0x7a
  jmp alltraps
801064c5:	e9 9e f6 ff ff       	jmp    80105b68 <alltraps>
...
801064cc:	6a 7b                	push   $0x7b
  jmp alltraps
801064ce:	e9 95 f6 ff ff       	jmp    80105b68 <alltraps>
...
801064d5:	6a 7c                	push   $0x7c
  jmp alltraps
801064d7:	e9 8c f6 ff ff       	jmp    80105b68 <alltraps>
...
801064de:	6a 7d                	push   $0x7d
  jmp alltraps
801064e0:	e9 83 f6 ff ff       	jmp    80105b68 <alltraps>
...
801064e7:	6a 7e                	push   $0x7e
  jmp alltraps
801064e9:	e9 7a f6 ff ff       	jmp    80105b68 <alltraps>
...
801064f0:	6a 7f                	push   $0x7f
  jmp alltraps
801064f2:	e9 71 f6 ff ff       	jmp    80105b68 <alltraps>
...
801064f9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801064fe:	e9 65 f6 ff ff       	jmp    80105b68 <alltraps>
...
80106505:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010650a:	e9 59 f6 ff ff       	jmp    80105b68 <alltraps>
...
80106511:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106516:	e9 4d f6 ff ff       	jmp    80105b68 <alltraps>
...
8010651d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106522:	e9 41 f6 ff ff       	jmp    80105b68 <alltraps>
...
80106529:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010652e:	e9 35 f6 ff ff       	jmp    80105b68 <alltraps>
...
80106535:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010653a:	e9 29 f6 ff ff       	jmp    80105b68 <alltraps>
...
80106541:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106546:	e9 1d f6 ff ff       	jmp    80105b68 <alltraps>
...
8010654d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106552:	e9 11 f6 ff ff       	jmp    80105b68 <alltraps>
...
80106559:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010655e:	e9 05 f6 ff ff       	jmp    80105b68 <alltraps>
...
80106565:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010656a:	e9 f9 f5 ff ff       	jmp    80105b68 <alltraps>
...
80106571:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106576:	e9 ed f5 ff ff       	jmp    80105b68 <alltraps>
...
8010657d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106582:	e9 e1 f5 ff ff       	jmp    80105b68 <alltraps>
...
80106589:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010658e:	e9 d5 f5 ff ff       	jmp    80105b68 <alltraps>
...
80106595:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010659a:	e9 c9 f5 ff ff       	jmp    80105b68 <alltraps>
...
801065a1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801065a6:	e9 bd f5 ff ff       	jmp    80105b68 <alltraps>
...
801065ad:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801065b2:	e9 b1 f5 ff ff       	jmp    80105b68 <alltraps>
...
801065b9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801065be:	e9 a5 f5 ff ff       	jmp    80105b68 <alltraps>
...
801065c5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801065ca:	e9 99 f5 ff ff       	jmp    80105b68 <alltraps>
...
801065d1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801065d6:	e9 8d f5 ff ff       	jmp    80105b68 <alltraps>
...
801065dd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801065e2:	e9 81 f5 ff ff       	jmp    80105b68 <alltraps>
...
801065e9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801065ee:	e9 75 f5 ff ff       	jmp    80105b68 <alltraps>
...
801065f5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801065fa:	e9 69 f5 ff ff       	jmp    80105b68 <alltraps>
...
80106601:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106606:	e9 5d f5 ff ff       	jmp    80105b68 <alltraps>
...
8010660d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106612:	e9 51 f5 ff ff       	jmp    80105b68 <alltraps>
...
80106619:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010661e:	e9 45 f5 ff ff       	jmp    80105b68 <alltraps>
...
80106625:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010662a:	e9 39 f5 ff ff       	jmp    80105b68 <alltraps>
...
80106631:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106636:	e9 2d f5 ff ff       	jmp    80105b68 <alltraps>
...
8010663d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106642:	e9 21 f5 ff ff       	jmp    80105b68 <alltraps>
...
80106649:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010664e:	e9 15 f5 ff ff       	jmp    80105b68 <alltraps>
...
80106655:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010665a:	e9 09 f5 ff ff       	jmp    80105b68 <alltraps>
...
80106661:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106666:	e9 fd f4 ff ff       	jmp    80105b68 <alltraps>
...
8010666d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106672:	e9 f1 f4 ff ff       	jmp    80105b68 <alltraps>
...
80106679:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010667e:	e9 e5 f4 ff ff       	jmp    80105b68 <alltraps>
...
80106685:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010668a:	e9 d9 f4 ff ff       	jmp    80105b68 <alltraps>
...
80106691:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106696:	e9 cd f4 ff ff       	jmp    80105b68 <alltraps>
...
8010669d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801066a2:	e9 c1 f4 ff ff       	jmp    80105b68 <alltraps>
...
801066a9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801066ae:	e9 b5 f4 ff ff       	jmp    80105b68 <alltraps>
...
801066b5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801066ba:	e9 a9 f4 ff ff       	jmp    80105b68 <alltraps>
...
801066c1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801066c6:	e9 9d f4 ff ff       	jmp    80105b68 <alltraps>
...
801066cd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801066d2:	e9 91 f4 ff ff       	jmp    80105b68 <alltraps>
...
801066d9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801066de:	e9 85 f4 ff ff       	jmp    80105b68 <alltraps>
...
801066e5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801066ea:	e9 79 f4 ff ff       	jmp    80105b68 <alltraps>
...
801066f1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801066f6:	e9 6d f4 ff ff       	jmp    80105b68 <alltraps>
...
801066fd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106702:	e9 61 f4 ff ff       	jmp    80105b68 <alltraps>
...
80106709:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010670e:	e9 55 f4 ff ff       	jmp    80105b68 <alltraps>
...
80106715:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010671a:	e9 49 f4 ff ff       	jmp    80105b68 <alltraps>
...
80106721:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106726:	e9 3d f4 ff ff       	jmp    80105b68 <alltraps>
...
8010672d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106732:	e9 31 f4 ff ff       	jmp    80105b68 <alltraps>
...
80106739:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010673e:	e9 25 f4 ff ff       	jmp    80105b68 <alltraps>
...
80106745:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010674a:	e9 19 f4 ff ff       	jmp    80105b68 <alltraps>
...
80106751:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106756:	e9 0d f4 ff ff       	jmp    80105b68 <alltraps>
...
8010675d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106762:	e9 01 f4 ff ff       	jmp    80105b68 <alltraps>
...
80106769:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010676e:	e9 f5 f3 ff ff       	jmp    80105b68 <alltraps>
...
80106775:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010677a:	e9 e9 f3 ff ff       	jmp    80105b68 <alltraps>
...
80106781:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106786:	e9 dd f3 ff ff       	jmp    80105b68 <alltraps>
...
8010678d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106792:	e9 d1 f3 ff ff       	jmp    80105b68 <alltraps>
...
80106799:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010679e:	e9 c5 f3 ff ff       	jmp    80105b68 <alltraps>
...
801067a5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801067aa:	e9 b9 f3 ff ff       	jmp    80105b68 <alltraps>
...
801067b1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801067b6:	e9 ad f3 ff ff       	jmp    80105b68 <alltraps>
...
801067bd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801067c2:	e9 a1 f3 ff ff       	jmp    80105b68 <alltraps>
...
801067c9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801067ce:	e9 95 f3 ff ff       	jmp    80105b68 <alltraps>
...
801067d5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801067da:	e9 89 f3 ff ff       	jmp    80105b68 <alltraps>
...
801067e1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801067e6:	e9 7d f3 ff ff       	jmp    80105b68 <alltraps>
...
801067ed:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801067f2:	e9 71 f3 ff ff       	jmp    80105b68 <alltraps>
...
801067f9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801067fe:	e9 65 f3 ff ff       	jmp    80105b68 <alltraps>
...
80106805:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010680a:	e9 59 f3 ff ff       	jmp    80105b68 <alltraps>
...
80106811:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106816:	e9 4d f3 ff ff       	jmp    80105b68 <alltraps>
...
8010681d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106822:	e9 41 f3 ff ff       	jmp    80105b68 <alltraps>
...
80106829:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010682e:	e9 35 f3 ff ff       	jmp    80105b68 <alltraps>
...
80106835:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010683a:	e9 29 f3 ff ff       	jmp    80105b68 <alltraps>
...
80106841:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106846:	e9 1d f3 ff ff       	jmp    80105b68 <alltraps>
...
8010684d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106852:	e9 11 f3 ff ff       	jmp    80105b68 <alltraps>
...
80106859:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010685e:	e9 05 f3 ff ff       	jmp    80105b68 <alltraps>
...
80106865:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010686a:	e9 f9 f2 ff ff       	jmp    80105b68 <alltraps>
...
80106871:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106876:	e9 ed f2 ff ff       	jmp    80105b68 <alltraps>
...
8010687d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106882:	e9 e1 f2 ff ff       	jmp    80105b68 <alltraps>
...
80106889:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010688e:	e9 d5 f2 ff ff       	jmp    80105b68 <alltraps>
...
80106895:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010689a:	e9 c9 f2 ff ff       	jmp    80105b68 <alltraps>
...
801068a1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801068a6:	e9 bd f2 ff ff       	jmp    80105b68 <alltraps>
...
801068ad:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801068b2:	e9 b1 f2 ff ff       	jmp    80105b68 <alltraps>
...
801068b9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801068be:	e9 a5 f2 ff ff       	jmp    80105b68 <alltraps>
...
801068c5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801068ca:	e9 99 f2 ff ff       	jmp    80105b68 <alltraps>
...
801068d1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801068d6:	e9 8d f2 ff ff       	jmp    80105b68 <alltraps>
...
801068dd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801068e2:	e9 81 f2 ff ff       	jmp    80105b68 <alltraps>
...
801068e9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801068ee:	e9 75 f2 ff ff       	jmp    80105b68 <alltraps>
...
801068f5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801068fa:	e9 69 f2 ff ff       	jmp    80105b68 <alltraps>
...
80106901:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106906:	e9 5d f2 ff ff       	jmp    80105b68 <alltraps>
...
8010690d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106912:	e9 51 f2 ff ff       	jmp    80105b68 <alltraps>
...
80106919:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010691e:	e9 45 f2 ff ff       	jmp    80105b68 <alltraps>
...
80106925:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010692a:	e9 39 f2 ff ff       	jmp    80105b68 <alltraps>
...
80106931:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106936:	e9 2d f2 ff ff       	jmp    80105b68 <alltraps>
...
8010693d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106942:	e9 21 f2 ff ff       	jmp    80105b68 <alltraps>
...
80106949:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010694e:	e9 15 f2 ff ff       	jmp    80105b68 <alltraps>
...
80106955:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010695a:	e9 09 f2 ff ff       	jmp    80105b68 <alltraps>
...
80106961:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106966:	e9 fd f1 ff ff       	jmp    80105b68 <alltraps>
...
8010696d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106972:	e9 f1 f1 ff ff       	jmp    80105b68 <alltraps>
...
80106979:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010697e:	e9 e5 f1 ff ff       	jmp    80105b68 <alltraps>
...
80106985:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010698a:	e9 d9 f1 ff ff       	jmp    80105b68 <alltraps>
...
80106991:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106996:	e9 cd f1 ff ff       	jmp    80105b68 <alltraps>
...
8010699d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801069a2:	e9 c1 f1 ff ff       	jmp    80105b68 <alltraps>
...
801069a9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801069ae:	e9 b5 f1 ff ff       	jmp    80105b68 <alltraps>
...
801069b5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801069ba:	e9 a9 f1 ff ff       	jmp    80105b68 <alltraps>
...
801069c1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801069c6:	e9 9d f1 ff ff       	jmp    80105b68 <alltraps>
...
801069cd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801069d2:	e9 91 f1 ff ff       	jmp    80105b68 <alltraps>
...
801069d9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801069de:	e9 85 f1 ff ff       	jmp    80105b68 <alltraps>
...
801069e5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801069ea:	e9 79 f1 ff ff       	jmp    80105b68 <alltraps>
...
801069f1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801069f6:	e9 6d f1 ff ff       	jmp    80105b68 <alltraps>
...
801069fd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106a02:	e9 61 f1 ff ff       	jmp    80105b68 <alltraps>
...
80106a09:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106a0e:	e9 55 f1 ff ff       	jmp    80105b68 <alltraps>
...
80106a15:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106a1a:	e9 49 f1 ff ff       	jmp    80105b68 <alltraps>
...
80106a21:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106a26:	e9 3d f1 ff ff       	jmp    80105b68 <alltraps>
...
80106a2d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106a32:	e9 31 f1 ff ff       	jmp    80105b68 <alltraps>
...
80106a39:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106a3e:	e9 25 f1 ff ff       	jmp    80105b68 <alltraps>
...
80106a45:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106a4a:	e9 19 f1 ff ff       	jmp    80105b68 <alltraps>
...
80106a51:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106a56:	e9 0d f1 ff ff       	jmp    80105b68 <alltraps>
...
80106a5d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106a62:	e9 01 f1 ff ff       	jmp    80105b68 <alltraps>
...
80106a69:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106a6e:	e9 f5 f0 ff ff       	jmp    80105b68 <alltraps>
...
80106a75:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106a7a:	e9 e9 f0 ff ff       	jmp    80105b68 <alltraps>
...
80106a81:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106a86:	e9 dd f0 ff ff       	jmp    80105b68 <alltraps>
...
80106a8d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106a92:	e9 d1 f0 ff ff       	jmp    80105b68 <alltraps>
...
80106a99:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106a9e:	e9 c5 f0 ff ff       	jmp    80105b68 <alltraps>
...
80106aa5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106aaa:	e9 b9 f0 ff ff       	jmp    80105b68 <alltraps>
...
80106ab1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106ab6:	e9 ad f0 ff ff       	jmp    80105b68 <alltraps>
...
80106abd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106ac2:	e9 a1 f0 ff ff       	jmp    80105b68 <alltraps>
...
80106ac9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106ace:	e9 95 f0 ff ff       	jmp    80105b68 <alltraps>
...
80106ad5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106ada:	e9 89 f0 ff ff       	jmp    80105b68 <alltraps>
...
80106ae1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106ae6:	e9 7d f0 ff ff       	jmp    80105b68 <alltraps>
...
80106aed:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106af2:	e9 71 f0 ff ff       	jmp    80105b68 <alltraps>
...
80106c45:	e8 d6 db ff ff       	call   80104820 <memset>
...
80106ca3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106ca6:	e8 85 cd ff ff       	call   80103a30 <cpuid>
  pd[0] = size-1;
...
80106d30:	a1 e4 49 11 80       	mov    0x801149e4,%eax
...
80106d64:	0f 84 c2 00 00 00    	je     80106e2c <switchuvm+0xec>
  pushcli();
80106d6a:	e8 a1 d8 ff ff       	call   80104610 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106d6f:	e8 5c cc ff ff       	call   801039d0 <mycpu>
80106d74:	89 c3                	mov    %eax,%ebx
80106d76:	e8 55 cc ff ff       	call   801039d0 <mycpu>
80106d7b:	89 c7                	mov    %eax,%edi
80106d7d:	e8 4e cc ff ff       	call   801039d0 <mycpu>
80106d82:	83 c7 08             	add    $0x8,%edi
80106d85:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106d88:	e8 43 cc ff ff       	call   801039d0 <mycpu>
...
80106e19:	5d                   	pop    %ebp
  popcli();
80106e1a:	e9 41 d8 ff ff       	jmp    80104660 <popcli>
...
80106e7f:	e8 9c d9 ff ff       	call   80104820 <memset>
...
80106eb2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106eb3:	e9 08 da ff ff       	jmp    801048c0 <memmove>
...
8010700b:	e8 10 d8 ff ff       	call   80104820 <memset>
...
801071c0:	e8 5b d6 ff ff       	call   80104820 <memset>
...
8010722b:	a3 e4 49 11 80       	mov    %eax,0x801149e4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107330:	e8 8b d5 ff ff       	call   801048c0 <memmove>
...
80107460:	e8 5b d4 ff ff       	call   801048c0 <memmove>
    len -= n;
    buf += n;
