...
int main() {
  ...
  36:	68 ac 0d 00 00       	push   $0xdac
  3b:	e8 40 06 00 00       	call   680 <strlen>
  40:	83 c4 0c             	add    $0xc,%esp
  43:	50                   	push   %eax
  44:	68 ac 0d 00 00       	push   $0xdac
  49:	53                   	push   %ebx
 ...
 90c:	89 d1                	mov    %edx,%ecx
{
 ...
 939:	0f b6 92 b0 0e 00 00 	movzbl 0xeb0(%edx),%edx
 ...
 9b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 a29:	ff 24 85 58 0e 00 00 	jmp    *0xe58(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 b37:	90                   	nop
          s = "(null)";
 b38:	ba 51 0e 00 00       	mov    $0xe51,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 b51:	a1 4c 12 00 00       	mov    0x124c,%eax
{
 ...
 b91:	5b                   	pop    %ebx
  freep = p;
 b92:	89 15 4c 12 00 00    	mov    %edx,0x124c
}
 b98:	5e                   	pop    %esi
 b99:	5f                   	pop    %edi
 b9a:	5d                   	pop    %ebp
 ...
 bc9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 bcc:	89 15 4c 12 00 00    	mov    %edx,0x124c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 be9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 bec:	8b 3d 4c 12 00 00    	mov    0x124c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 c2f:	73 4f                	jae    c80 <malloc+0xa0>
    ...
    if(p == freep)
 c31:	8b 3d 4c 12 00 00    	mov    0x124c,%edi
 ...
 c5a:	e8 f1 fe ff ff       	call   b50 <free>
  return freep;
 c5f:	8b 15 4c 12 00 00    	mov    0x124c,%edx
 ...
 c8c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 c8f:	89 15 4c 12 00 00    	mov    %edx,0x124c
}
 ...
 c9f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 ca0:	c7 05 4c 12 00 00 50 	movl   $0x1250,0x124c
 ca7:	12 00 00 
    base.s.size = 0;
 caa:	bf 50 12 00 00       	mov    $0x1250,%edi
    base.s.ptr = freep = prevp = &base;
 caf:	c7 05 50 12 00 00 50 	movl   $0x1250,0x1250
 cb6:	12 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 cb9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 cbb:	c7 05 54 12 00 00 00 	movl   $0x0,0x1254
 cc2:	00 00 00 
    if(p->s.size >= nunits){
